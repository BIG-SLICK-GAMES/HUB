...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Jo(e,t,n){let r=new Float32Array(Po),i=new V(0,1,0);return new fa({name:`SphericalGaussianBlur`,defines:{n:Po,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:Zo(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Yo(){return new fa({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:Zo(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Xo(){return new fa({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Zo(),fragmentShader:`
	...
	`}var Qo=class extends zt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new Ri(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`)}var Cc={1:`Linear`,2:`Reinhard`,3:`Cineon`,4:`ACESFilmic`,6:`AgX`,7:`Neutral`,5:`Custom`};function wc(e,t){let n=Cc[t];return n===void 0?(I(`WebGLProgram: Unsupported toneMapping:`,t),`vec3 `+e+`( vec3 color ) { return LinearToneMapping( color ); }`):`vec3 `+e+`( vec3 color ) { return `+n+`ToneMapping( color ); }`}var Tc=new V;function Ec(){return U.getLuminanceCoefficients(Tc),[`float luminance( const in vec3 rgb ) {`,`	const vec3 weights = vec3( ${Tc.x.toFixed(4)}, ${Tc.y.toFixed(4)}, ${Tc.z.toFixed(4)} );`,`	return dot( weights, rgb );`,`}`].join(`
...
`)+`
`+_);let y=v+g+o,b=v+_+s,x=hc(i,i.VERTEX_SHADER,y),S=hc(i,i.FRAGMENT_SHADER,b);i.attachShader(h,x),i.attachShader(h,S),n.index0AttributeName===void 0?n.hasPositionAttribute===!0&&i.bindAttribLocation(h,0,`position`):i.bindAttribLocation(h,0,n.index0AttributeName),i.linkProgram(h);function C(t){if(e.debug.checkShaderErrors){let n=i.getProgramInfoLog(h)||``,r=i.getShaderInfoLog(x)||``,a=i.getShaderInfoLog(S)||``,o=n.trim(),s=r.trim(),c=a.trim(),l=!0,u=!0;if(i.getProgramParameter(h,i.LINK_STATUS)===!1)if(l=!1,typeof e.debug.onShaderError==`function`)e.debug.onShaderError(i,h,x,S);else{let e=xc(i,x,`vertex`),n=xc(i,S,`fragment`);L(`WebGLProgram: Shader Error `+i.getError()+` - VALIDATE_STATUS `+i.getProgramParameter(h,i.VALIDATE_STATUS)+`
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
...
}`,Dl=class{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(e,t){if(this.texture===null){let n=new Hi(e.texture);(e.depthNear!==t.depthNear||e.depthFar!==t.depthFar)&&(this.depthNear=e.depthNear,this.depthFar=e.depthFar),this.texture=n}}getMesh(e){if(this.texture!==null&&this.mesh===null){let t=e.cameras[0].viewport,n=new fa({vertexShader:Tl,fragmentShader:El,uniforms:{depthColor:{value:this.texture},depthWidth:{value:t.z},depthHeight:{value:t.w}}});this.mesh=new K(new Qi(20,20),n)}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}},Ol=class extends ft{constructor(e,t){super();let n=this,r=null,i=1,a=null,o=`local-floor`,s=1,c=null,l=null,u=null,d=null,f=null,p=null,m=typeof XRWebGLBinding<`u`,h=new Dl,g={},_=t.getContextAttributes(),y=null,b=null,x=[],S=[],w=new B,T=null,E=new Ka;E.viewport=new Lt;let D=new Ka;D.viewport=new Lt;let O=[E,D],k=new to,te=null,ne=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(e){let t=x[e];return t===void 0&&(t=new yn,x[e]=t),t.getTargetRaySpace()},this.getControllerGrip=function(e){let t=x[e];return t===void 0&&(t=new yn,x[e]=t),t.getGripSpace()},this.getHand=function(e){let t=x[e];return t===void 0&&(t=new yn,x[e]=t),t.getHandSpace()};function ae(e){let t=S.indexOf(e.inputSource);if(t===-1)return;let n=x[t];n!==void 0&&(n.update(e.inputSource,e.frame,c||a),n.dispatchEvent({type:e.type,data:e.inputSource}))}function oe(){r.removeEventListener(`select`,ae),r.removeEventListener(`selectstart`,ae),r.removeEventListener(`selectend`,ae),r.removeEventListener(`squeeze`,ae),r.removeEventListener(`squeezestart`,ae),r.removeEventListener(`squeezeend`,ae),r.removeEventListener(`end`,oe),r.removeEventListener(`inputsourceschange`,se);for(let e=0;e<x.length;e++){let t=S[e];t!==null&&(S[e]=null,x[e].disconnect(t))}te=null,ne=null,h.reset();for(let e in g)delete g[e];e.setRenderTarget(y),f=null,d=null,u=null,r=null,b=null,me.stop(),n.isPresenting=!1,e.setPixelRatio(T),e.setSize(w.width,w.height,!1),n.dispatchEvent({type:`sessionend`})}this.setFramebufferScaleFactor=function(e){i=e,n.isPresenting===!0&&I(`WebXRManager: Cannot change framebuffer scale while presenting.`)},this.setReferenceSpaceType=function(e){o=e,n.isPresenting===!0&&I(`WebXRManager: Cannot change reference space type while presenting.`)},this.getReferenceSpace=function(){return c||a},this.setReferenceSpace=function(e){c=e},this.getBaseLayer=function(){return d===null?f:d},this.getBinding=function(){return u===null&&m&&(u=new XRWebGLBinding(r,t)),u},this.getFrame=function(){return p},this.getSession=function(){return r},this.setSession=async function(l){if(r=l,r!==null){if(y=e.getRenderTarget(),r.addEventListener(`select`,ae),r.addEventListener(`selectstart`,ae),r.addEventListener(`selectend`,ae),r.addEventListener(`squeeze`,ae),r.addEventListener(`squeezestart`,ae),r.addEventListener(`squeezeend`,ae),r.addEventListener(`end`,oe),r.addEventListener(`inputsourceschange`,se),_.xrCompatible!==!0&&await t.makeXRCompatible(),T=e.getPixelRatio(),e.getSize(w),m&&`createProjectionLayer`in XRWebGLBinding.prototype){let n=null,a=null,o=null;_.depth&&(o=_.stencil?t.DEPTH24_STENCIL8:t.DEPTH_COMPONENT24,n=_.stencil?ie:re,a=_.stencil?ee:C);let s={colorFormat:t.RGBA8,depthFormat:o,scaleFactor:i};u=this.getBinding(),d=u.createProjectionLayer(s),r.updateRenderState({layers:[d]}),e.setPixelRatio(1),e.setSize(d.textureWidth,d.textureHeight,!1),b=new zt(d.textureWidth,d.textureHeight,{format:A,type:v,depthTexture:new Bi(d.textureWidth,d.textureHeight,a,void 0,void 0,void 0,void 0,void 0,void 0,n),stencilBuffer:_.stencil,colorSpace:e.outputColorSpace,samples:_.antialias?4:0,resolveDepthBuffer:d.ignoreDepthValues===!1,resolveStencilBuffer:d.ignoreDepthValues===!1})}else{let n={antialias:_.antialias,alpha:!0,depth:_.depth,stencil:_.stencil,framebufferScaleFactor:i};f=new XRWebGLLayer(r,t,n),r.updateRenderState({baseLayer:f}),e.setPixelRatio(1),e.setSize(f.framebufferWidth,f.framebufferHeight,!1),b=new zt(f.framebufferWidth,f.framebufferHeight,{format:A,type:v,colorSpace:e.outputColorSpace,stencilBuffer:_.stencil,resolveDepthBuffer:f.ignoreDepthValues===!1,resolveStencilBuffer:f.ignoreDepthValues===!1})}b.isXRRenderTarget=!0,this.setFoveation(s),c=null,a=await r.requestReferenceSpace(o),me.setContext(r),me.start(),n.isPresenting=!0,n.dispatchEvent({type:`sessionstart`})}},this.getEnvironmentBlendMode=function(){if(r!==null)return r.environmentBlendMode},this.getDepthTexture=function(){return h.getDepthTexture()};function se(e){for(let t=0;t<e.removed.length;t++){let n=e.removed[t],r=S.indexOf(n);r>=0&&(S[r]=null,x[r].disconnect(n))}for(let t=0;t<e.added.length;t++){let n=e.added[t],r=S.indexOf(n);if(r===-1){for(let e=0;e<x.length;e++)if(e>=S.length){S.push(n),r=e;break}else if(S[e]===null){S[e]=n,r=e;break}if(r===-1)break}let i=x[r];i&&i.connect(n)}}let ce=new V,le=new V;function ue(e,t,n){ce.setFromMatrixPosition(t.matrixWorld),le.setFromMatrixPosition(n.matrixWorld);let r=ce.distanceTo(le),i=t.projectionMatrix.elements,a=n.projectionMatrix.elements,o=i[14]/(i[10]-1),s=i[14]/(i[10]+1),c=(i[9]+1)/i[5],l=(i[9]-1)/i[5],u=(i[8]-1)/i[0],d=(a[8]+1)/a[0],f=o*u,p=o*d,m=r/(-u+d),h=m*-u;if(t.matrixWorld.decompose(e.position,e.quaternion,e.scale),e.translateX(h),e.translateZ(m),e.matrixWorld.compose(e.position,e.quaternion,e.scale),e.matrixWorldInverse.copy(e.matrixWorld).invert(),i[10]===-1)e.projectionMatrix.copy(t.projectionMatrix),e.projectionMatrixInverse.copy(t.projectionMatrixInverse);else{let t=o+m,n=s+m,i=f-h,a=p+(r-h),u=c*s/n*t,d=l*s/n*t;e.projectionMatrix.makePerspective(i,a,u,d,t,n),e.projectionMatrixInverse.copy(e.projectionMatrix).invert()}}function de(e,t){t===null?e.matrixWorld.copy(e.matrix):e.matrixWorld.multiplyMatrices(t.matrixWorld,e.matrix),e.matrixWorldInverse.copy(e.matrixWorld).invert()}this.updateCamera=function(e){if(r===null)return;let t=e.near,n=e.far;h.texture!==null&&(h.depthNear>0&&(t=h.depthNear),h.depthFar>0&&(n=h.depthFar)),k.near=D.near=E.near=t,k.far=D.far=E.far=n,(te!==k.near||ne!==k.far)&&(r.updateRenderState({depthNear:k.near,depthFar:k.far}),te=k.near,ne=k.far),k.layers.mask=e.layers.mask|6,E.layers.mask=k.layers.mask&-5,D.layers.mask=k.layers.mask&-3;let i=e.parent,a=k.cameras;de(k,i);for(let e=0;e<a.length;e++)de(a[e],i);a.length===2?ue(k,E,D):k.projectionMatrix.copy(E.projectionMatrix),fe(e,k,i)};function fe(e,t,n){n===null?e.matrix.copy(t.matrixWorld):(e.matrix.copy(n.matrixWorld),e.matrix.invert(),e.matrix.multiply(t.matrixWorld)),e.matrix.decompose(e.position,e.quaternion,e.scale),e.updateMatrixWorld(!0),e.projectionMatrix.copy(t.projectionMatrix),e.projectionMatrixInverse.copy(t.projectionMatrixInverse),e.isPerspectiveCamera&&(e.fov=ht*2*Math.atan(1/e.projectionMatrix.elements[5]),e.zoom=1)}this.getCamera=function(){return k},this.getFoveation=function(){if(!(d===null&&f===null))return s},this.setFoveation=function(e){s=e,d!==null&&(d.fixedFoveation=e),f!==null&&f.fixedFoveation!==void 0&&(f.fixedFoveation=e)},this.hasDepthSensing=function(){return h.texture!==null},this.getDepthSensingMesh=function(){return h.getMesh(k)},this.getCameraTexture=function(e){return g[e]};let j=null;function pe(t,i){if(l=i.getViewerPose(c||a),p=i,l!==null){let t=l.views;f!==null&&(e.setRenderTargetFramebuffer(b,f.framebuffer),e.setRenderTarget(b));let i=!1;t.length!==k.cameras.length&&(k.cameras.length=0,i=!0);for(let n=0;n<t.length;n++){let r=t[n],a=null;if(f!==null)a=f.getViewport(r);else{let t=u.getViewSubImage(d,r);a=t.viewport,n===0&&(e.setRenderTargetTextures(b,t.colorTexture,t.depthStencilTexture),e.setRenderTarget(b))}let o=O[n];o===void 0&&(o=new Ka,o.layers.enable(n),o.viewport=new Lt,O[n]=o),o.matrix.fromArray(r.transform.matrix),o.matrix.decompose(o.position,o.quaternion,o.scale),o.projectionMatrix.fromArray(r.projectionMatrix),o.projectionMatrixInverse.copy(o.projectionMatrix).invert(),o.viewport.set(a.x,a.y,a.width,a.height),n===0&&(k.matrix.copy(o.matrix),k.matrix.decompose(k.position,k.quaternion,k.scale)),i===!0&&k.cameras.push(o)}let a=r.enabledFeatures;if(a&&a.includes(`depth-sensing`)&&r.depthUsage==`gpu-optimized`&&m){u=n.getBinding();let e=u.getDepthInformation(t[0]);e&&e.isValid&&e.texture&&h.init(e,r.renderState)}if(a&&a.includes(`camera-access`)&&m){e.state.unbindTexture(),u=n.getBinding();for(let e=0;e<t.length;e++){let n=t[e].camera;if(n){let e=g[n];e||(e=new Hi,g[n]=e);let t=u.getCameraImage(n);e.sourceTexture=t}}}}for(let e=0;e<x.length;e++){let t=S[e],n=x[e];t!==null&&n!==void 0&&n.update(t,i,c||a)}j&&j(t,i),i.detectedPlanes&&n.dispatchEvent({type:`planesdetected`,data:i}),p=null}let me=new xo;me.setAnimationLoop(pe),this.setAnimationLoop=function(e){j=e},this.dispose=function(){}}},kl=new Ht,Al=new H;Al.set(-1,0,0,0,1,0,0,0,1);function jl(e,t){function n(e,t){e.matrixAutoUpdate===!0&&e.updateMatrix(),t.value.copy(e.matrix)}function r(t,n){n.color.getRGB(t.fogColor.value,ca(e)),n.isFog?(t.fogNear.value=n.near,t.fogFar.value=n.far):n.isFogExp2&&(t.fogDensity.value=n.density)}function i(e,t,n,r,i){t.isNodeMaterial?t.uniformsNeedUpdate=!1:t.isMeshBasicMaterial?a(e,t):t.isMeshLambertMaterial?(a(e,t),t.envMap&&(e.envMapIntensity.value=t.envMapIntensity)):t.isMeshToonMaterial?(a(e,t),d(e,t)):t.isMeshPhongMaterial?(a(e,t),u(e,t),t.envMap&&(e.envMapIntensity.value=t.envMapIntensity)):t.isMeshStandardMaterial?(a(e,t),f(e,t),t.isMeshPhysicalMaterial&&p(e,t,i)):t.isMeshMatcapMaterial?(a(e,t),m(e,t)):t.isMeshDepthMaterial?a(e,t):t.isMeshDistanceMaterial?(a(e,t),h(e,t)):t.isMeshNormalMaterial?a(e,t):t.isLineBasicMaterial?(o(e,t),t.isLineDashedMaterial&&s(e,t)):t.isPointsMaterial?c(e,t,n,r):t.isSpriteMaterial?l(e,t):t.isShadowMaterial?(e.color.value.copy(t.color),e.opacity.value=t.opacity):t.isShaderMaterial&&(t.uniformsNeedUpdate=!1)}function a(e,r){e.opacity.value=r.opacity,r.color&&e.diffuse.value.copy(r.color),r.emissive&&e.emissive.value.copy(r.emissive).multiplyScalar(r.emissiveIntensity),r.map&&(e.map.value=r.map,n(r.map,e.mapTransform)),r.alphaMap&&(e.alphaMap.value=r.alphaMap,n(r.alphaMap,e.alphaMapTransform)),r.bumpMap&&(e.bumpMap.value=r.bumpMap,n(r.bumpMap,e.bumpMapTransform),e.bumpScale.value=r.bumpScale,r.side===1&&(e.bumpScale.value*=-1)),r.normalMap&&(e.normalMap.value=r.normalMap,n(r.normalMap,e.normalMapTransform),e.normalScale.value.copy(r.normalScale),r.side===1&&e.normalScale.value.negate()),r.displacementMap&&(e.displacementMap.value=r.displacementMap,n(r.displacementMap,e.displacementMapTransform),e.displacementScale.value=r.displacementScale,e.displacementBias.value=r.displacementBias),r.emissiveMap&&(e.emissiveMap.value=r.emissiveMap,n(r.emissiveMap,e.emissiveMapTransform)),r.specularMap&&(e.specularMap.value=r.specularMap,n(r.specularMap,e.specularMapTransform)),r.alphaTest>0&&(e.alphaTest.value=r.alphaTest);let i=t.get(r),a=i.envMap,o=i.envMapRotation;a&&(e.envMap.value=a,e.envMapRotation.value.setFromMatrix4(kl.makeRotationFromEuler(o)).transpose(),a.isCubeTexture&&a.isRenderTargetTexture===!1&&e.envMapRotation.value.premultiply(Al),e.reflectivity.value=r.reflectivity,e.ior.value=r.ior,e.refractionRatio.value=r.refractionRatio),r.lightMap&&(e.lightMap.value=r.lightMap,e.lightMapIntensity.value=r.lightMapIntensity,n(r.lightMap,e.lightMapTransform)),r.aoMap&&(e.aoMap.value=r.aoMap,e.aoMapIntensity.value=r.aoMapIntensity,n(r.aoMap,e.aoMapTransform))}function o(e,t){e.diffuse.value.copy(t.color),e.opacity.value=t.opacity,t.map&&(e.map.value=t.map,n(t.map,e.mapTransform))}function s(e,t){e.dashSize.value=t.dashSize,e.totalSize.value=t.dashSize+t.gapSize,e.scale.value=t.scale}function c(e,t,r,i){e.diffuse.value.copy(t.color),e.opacity.value=t.opacity,e.size.value=t.size*r,e.scale.value=i*.5,t.map&&(e.map.value=t.map,n(t.map,e.uvTransform)),t.alphaMap&&(e.alphaMap.value=t.alphaMap,n(t.alphaMap,e.alphaMapTransform)),t.alphaTest>0&&(e.alphaTest.value=t.alphaTest)}function l(e,t){e.diffuse.value.copy(t.color),e.opacity.value=t.opacity,e.rotation.value=t.rotation,t.map&&(e.map.value=t.map,n(t.map,e.mapTransform)),t.alphaMap&&(e.alphaMap.value=t.alphaMap,n(t.alphaMap,e.alphaMapTransform)),t.alphaTest>0&&(e.alphaTest.value=t.alphaTest)}function u(e,t){e.specular.value.copy(t.specular),e.shininess.value=Math.max(t.shininess,1e-4)}function d(e,t){t.gradientMap&&(e.gradientMap.value=t.gradientMap)}function f(e,t){e.metalness.value=t.metalness,t.metalnessMap&&(e.metalnessMap.value=t.metalnessMap,n(t.metalnessMap,e.metalnessMapTransform)),e.roughness.value=t.roughness,t.roughnessMap&&(e.roughnessMap.value=t.roughnessMap,n(t.roughnessMap,e.roughnessMapTransform)),t.envMap&&(e.envMapIntensity.value=t.envMapIntensity)}function p(e,t,r){e.ior.value=t.ior,t.sheen>0&&(e.sheenColor.value.copy(t.sheenColor).multiplyScalar(t.sheen),e.sheenRoughness.value=t.sheenRoughness,t.sheenColorMap&&(e.sheenColorMap.value=t.sheenColorMap,n(t.sheenColorMap,e.sheenColorMapTransform)),t.sheenRoughnessMap&&(e.sheenRoughnessMap.value=t.sheenRoughnessMap,n(t.sheenRoughnessMap,e.sheenRoughnessMapTransform))),t.clearcoat>0&&(e.clearcoat.value=t.clearcoat,e.clearcoatRoughness.value=t.clearcoatRoughness,t.clearcoatMap&&(e.clearcoatMap.value=t.clearcoatMap,n(t.clearcoatMap,e.clearcoatMapTransform)),t.clearcoatRoughnessMap&&(e.clearcoatRoughnessMap.value=t.clearcoatRoughnessMap,n(t.clearcoatRoughnessMap,e.clearcoatRoughnessMapTransform)),t.clearcoatNormalMap&&(e.clearcoatNormalMap.value=t.clearcoatNormalMap,n(t.clearcoatNormalMap,e.clearcoatNormalMapTransform),e.clearcoatNormalScale.value.copy(t.clearcoatNormalScale),t.side===1&&e.clearcoatNormalScale.value.negate())),t.dispersion>0&&(e.dispersion.value=t.dispersion),t.iridescence>0&&(e.iridescence.value=t.iridescence,e.iridescenceIOR.value=t.iridescenceIOR,e.iridescenceThicknessMinimum.value=t.iridescenceThicknessRange[0],e.iridescenceThicknessMaximum.value=t.iridescenceThicknessRange[1],t.iridescenceMap&&(e.iridescenceMap.value=t.iridescenceMap,n(t.iridescenceMap,e.iridescenceMapTransform)),t.iridescenceThicknessMap&&(e.iridescenceThicknessMap.value=t.iridescenceThicknessMap,n(t.iridescenceThicknessMap,e.iridescenceThicknessMapTransform))),t.transmission>0&&(e.transmission.value=t.transmission,e.transmissionSamplerMap.value=r.texture,e.transmissionSamplerSize.value.set(r.width,r.height),t.transmissionMap&&(e.transmissionMap.value=t.transmissionMap,n(t.transmissionMap,e.transmissionMapTransform)),e.thickness.value=t.thickness,t.thicknessMap&&(e.thicknessMap.value=t.thicknessMap,n(t.thicknessMap,e.thicknessMapTransform)),e.attenuationDistance.value=t.attenuationDistance,e.attenuationColor.value.copy(t.attenuationColor)),t.anisotropy>0&&(e.anisotropyVector.value.set(t.anisotropy*Math.cos(t.anisotropyRotation),t.anisotropy*Math.sin(t.anisotropyRotation)),t.anisotropyMap&&(e.anisotropyMap.value=t.anisotropyMap,n(t.anisotropyMap,e.anisotropyMapTransform))),e.specularIntensity.value=t.specularIntensity,e.specularColor.value.copy(t.specularColor),t.specularColorMap&&(e.specularColorMap.value=t.specularColorMap,n(t.specularColorMap,e.specularColorMapTransform)),t.specularIntensityMap&&(e.specularIntensityMap.value=t.specularIntensityMap,n(t.specularIntensityMap,e.specularIntensityMapTransform))}function m(e,t){t.matcap&&(e.matcap.value=t.matcap)}function h(e,n){let r=t.get(n).light;e.referencePosition.value.setFromMatrixPosition(r.matrixWorld),e.nearDistance.value=r.shadow.camera.near,e.farDistance.value=r.shadow.camera.far}return{refreshFogUniforms:r,refreshMaterialUniforms:i}}function Ml(e,t,n,r){let i={},a={},o=[],s=e.getParameter(e.MAX_UNIFORM_BUFFER_BINDINGS);function c(e,t){let n=t.program;r.uniformBlockBinding(e,n)}function l(e,n){let o=i[e.id];o===void 0&&(g(e),o=u(e),i[e.id]=o,e.addEventListener(`dispose`,v));let s=n.program;r.updateUBOMapping(e,s);let c=t.render.frame;a[e.id]!==c&&(f(e),a[e.id]=c)}function u(t){let n=d();t.__bindingPointIndex=n;let r=e.createBuffer(),i=t.__size,a=t.usage;return e.bindBuffer(e.UNIFORM_BUFFER,r),e.bufferData(e.UNIFORM_BUFFER,i,a),e.bindBuffer(e.UNIFORM_BUFFER,null),e.bindBufferBase(e.UNIFORM_BUFFER,n,r),r}function d(){for(let e=0;e<s;e++)if(o.indexOf(e)===-1)return o.push(e),e;return L(`WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached.`),0}function f(t){let n=i[t.id],r=t.uniforms,a=t.__cache;e.bindBuffer(e.UNIFORM_BUFFER,n);for(let e=0,t=r.length;e<t;e++){let t=r[e];if(Array.isArray(t))for(let n=0,r=t.length;n<r;n++)p(t[n],e,n,a);else p(t,e,0,a)}e.bindBuffer(e.UNIFORM_BUFFER,null)}function p(t,n,r,i){if(h(t,n,r,i)===!0){let n=t.__offset,r=t.value;if(Array.isArray(r)){let e=0;for(let n=0;n<r.length;n++){let i=r[n],a=_(i);m(i,t.__data,e),typeof i!=`number`&&typeof i!=`boolean`&&!i.isMatrix3&&!ArrayBuffer.isView(i)&&(e+=a.storage/Float32Array.BYTES_PER_ELEMENT)}}else m(r,t.__data,0);e.bufferSubData(e.UNIFORM_BUFFER,n,t.__data)}}function m(e,t,n){typeof e==`number`||typeof e==`boolean`?t[0]=e:e.isMatrix3?(t[0]=e.elements[0],t[1]=e.elements[1],t[2]=e.elements[2],t[3]=0,t[4]=e.elements[3],t[5]=e.elements[4],t[6]=e.elements[5],t[7]=0,t[8]=e.elements[6],t[9]=e.elements[7],t[10]=e.elements[8],t[11]=0):ArrayBuffer.isView(e)?t.set(new e.constructor(e.buffer,e.byteOffset,t.length)):e.toArray(t,n)}function h(e,t,n,r){let i=e.value,a=t+`_`+n;if(r[a]===void 0)return typeof i==`number`||typeof i==`boolean`?r[a]=i:ArrayBuffer.isView(i)?r[a]=i.slice():r[a]=i.clone(),!0;{let e=r[a];if(typeof i==`number`||typeof i==`boolean`){if(e!==i)return r[a]=i,!0}else if(ArrayBuffer.isView(i))return!0;else if(e.equals(i)===!1)return e.copy(i),!0}return!1}function g(e){let t=e.uniforms,n=0;for(let e=0,r=t.length;e<r;e++){let r=Array.isArray(t[e])?t[e]:[t[e]];for(let e=0,t=r.length;e<t;e++){let t=r[e],i=Array.isArray(t.value)?t.value:[t.value];for(let e=0,r=i.length;e<r;e++){let r=i[e],a=_(r),o=n%16,s=o%a.boundary,c=o+s;n+=s,c!==0&&16-c<a.storage&&(n+=16-c),t.__data=new Float32Array(a.storage/Float32Array.BYTES_PER_ELEMENT),t.__offset=n,n+=a.storage}}}let r=n%16;return r>0&&(n+=16-r),e.__size=n,e.__cache={},this}function _(e){let t={boundary:0,storage:0};return typeof e==`number`||typeof e==`boolean`?(t.boundary=4,t.storage=4):e.isVector2?(t.boundary=8,t.storage=8):e.isVector3||e.isColor?(t.boundary=16,t.storage=12):e.isVector4?(t.boundary=16,t.storage=16):e.isMatrix3?(t.boundary=48,t.storage=48):e.isMatrix4?(t.boundary=64,t.storage=64):e.isTexture?I(`WebGLRenderer: Texture samplers can not be part of an uniforms group.`):ArrayBuffer.isView(e)?(t.boundary=16,t.storage=e.byteLength):I(`WebGLRenderer: Unsupported uniform value type.`,e),t}function v(t){let n=t.target;n.removeEventListener(`dispose`,v);let r=o.indexOf(n.__bindingPointIndex);o.splice(r,1),e.deleteBuffer(i[n.id]),delete i[n.id],delete a[n.id]}function y(){for(let t in i)e.deleteBuffer(i[t]);o=[],i={},a={}}return{bind:c,update:l,dispose:y}}var Nl=new Uint16Array([12469,15057,12620,14925,13266,14620,13807,14376,14323,13990,14545,13625,14713,13328,14840,12882,14931,12528,14996,12233,15039,11829,15066,11525,15080,11295,15085,10976,15082,10705,15073,10495,13880,14564,13898,14542,13977,14430,14158,14124,14393,13732,14556,13410,14702,12996,14814,12596,14891,12291,14937,11834,14957,11489,14958,11194,14943,10803,14921,10506,14893,10278,14858,9960,14484,14039,14487,14025,14499,13941,14524,13740,14574,13468,14654,13106,14743,12678,14818,12344,14867,11893,14889,11509,14893,11180,14881,10751,14852,10428,14812,10128,14765,9754,14712,9466,14764,13480,14764,13475,14766,13440,14766,13347,14769,13070,14786,12713,14816,12387,14844,11957,14860,11549,14868,11215,14855,10751,14825,10403,14782,10044,14729,9651,14666,9352,14599,9029,14967,12835,14966,12831,14963,12804,14954,12723,14936,12564,14917,12347,14900,11958,14886,11569,14878,11247,14859,10765,14828,10401,14784,10011,14727,9600,14660,9289,14586,8893,14508,8533,15111,12234,15110,12234,15104,12216,15092,12156,15067,12010,15028,11776,14981,11500,14942,11205,14902,10752,14861,10393,14812,9991,14752,9570,14682,9252,14603,8808,14519,8445,14431,8145,15209,11449,15208,11451,15202,11451,15190,11438,15163,11384,15117,11274,15055,10979,14994,10648,14932,10343,14871,9936,14803,9532,14729,9218,14645,8742,14556,8381,14461,8020,14365,7603,15273,10603,15272,10607,15267,10619,15256,10631,15231,10614,15182,10535,15118,10389,15042,10167,14963,9787,14883,9447,14800,9115,14710,8665,14615,8318,14514,7911,14411,7507,14279,7198,15314,9675,15313,9683,15309,9712,15298,9759,15277,9797,15229,9773,15166,9668,15084,9487,14995,9274,14898,8910,14800,8539,14697,8234,14590,7790,14479,7409,14367,7067,14178,6621,15337,8619,15337,8631,15333,8677,15325,8769,15305,8871,15264,8940,15202,8909,15119,8775,15022,8565,14916,8328,14804,8009,14688,7614,14569,7287,14448,6888,14321,6483,14088,6171,15350,7402,15350,7419,15347,7480,15340,7613,15322,7804,15287,7973,15229,8057,15148,8012,15046,7846,14933,7611,14810,7357,14682,7069,14552,6656,14421,6316,14251,5948,14007,5528,15356,5942,15356,5977,15353,6119,15348,6294,15332,6551,15302,6824,15249,7044,15171,7122,15070,7050,14949,6861,14818,6611,14679,6349,14538,6067,14398,5651,14189,5311,13935,4958,15359,4123,15359,4153,15356,4296,15353,4646,15338,5160,15311,5508,15263,5829,15188,6042,15088,6094,14966,6001,14826,5796,14678,5543,14527,5287,14377,4985,14133,4586,13869,4257,15360,1563,15360,1642,15358,2076,15354,2636,15341,3350,15317,4019,15273,4429,15203,4732,15105,4911,14981,4932,14836,4818,14679,4621,14517,4386,14359,4156,14083,3795,13808,3437,15360,122,15360,137,15358,285,15355,636,15344,1274,15322,2177,15281,2765,15215,3223,15120,3451,14995,3569,14846,3567,14681,3466,14511,3305,14344,3121,14037,2800,13753,2467,15360,0,15360,1,15359,21,15355,89,15346,253,15325,479,15287,796,15225,1148,15133,1492,15008,1749,14856,1882,14685,1886,14506,1783,14324,1608,13996,1398,13702,1183]),Pl=null;function Fl(){return Pl===null&&(Pl=new li(Nl,16,16,se,T),Pl.name=`DFG_LUT`,Pl.minFilter=h,Pl.magFilter=h,Pl.wrapS=u,Pl.wrapT=u,Pl.generateMipmaps=!1,Pl.needsUpdate=!0),Pl}var Il=class{constructor(e={}){let{canvas:t=at(),context:n=null,depth:r=!0,stencil:i=!1,alpha:a=!1,antialias:o=!1,premultipliedAlpha:s=!0,preserveDrawingBuffer:c=!1,powerPreference:l=`default`,failIfMajorPerformanceCaveat:u=!1,reversedDepthBuffer:d=!1,outputBufferType:f=v}=e;this.isWebGLRenderer=!0;let p;if(n!==null){if(typeof WebGLRenderingContext<`u`&&n instanceof WebGLRenderingContext)throw Error(`THREE.WebGLRenderer: WebGL 1 is not supported since r163.`);p=n.getContextAttributes().alpha}else p=a;let m=f,h=new Set([le,ce,oe]),g=new Set([v,C,x,ee,E,D]),y=new Uint32Array(4),b=new Int32Array(4),S=new V,w=null,O=null,k=[],te=[],ne=null;this.domElement=t,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this.toneMapping=0,this.toneMappingExposure=1,this.transmissionResolutionScale=1;let A=this,re=!1,ie=null,ae=null,se=null,ue=null;this._outputColorSpace=Ye;let de=0,fe=0,j=null,pe=-1,me=null,he=new Lt,ge=new Lt,_e=null,ve=new W(0),ye=0,be=t.width,xe=t.height,Se=1,Ce=null,we=null,Te=new Lt(0,0,be,xe),Ee=new Lt(0,0,be,xe),De=!1,Oe=new _i,ke=!1,Ae=!1,je=new Ht,Me=new V,Ne=new Lt,Pe={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0},Fe=!1;function Ie(){return j===null?Se:1}let M=n;function Le(e,n){return t.getContext(e,n)}try{let e={alpha:!0,depth:r,stencil:i,antialias:o,premultipliedAlpha:s,preserveDrawingBuffer:c,powerPreference:l,failIfMajorPerformanceCaveat:u};if(`setAttribute`in t&&t.setAttribute(`data-engine`,`three.js r185`),t.addEventListener(`webglcontextlost`,dt,!1),t.addEventListener(`webglcontextrestored`,ft,!1),t.addEventListener(`webglcontextcreationerror`,pt,!1),M===null){let t=`webgl2`;if(M=Le(t,e),M===null)throw Le(t)?Error(`THREE.WebGLRenderer: Error creating WebGL context with your selected attributes.`):Error(`THREE.WebGLRenderer: Error creating WebGL context.`)}}catch(e){throw L(`WebGLRenderer: `+e.message),e}let Re,ze,N,Be,P,F,Ve,He,Ue,We,Ge,Ke,qe,Je,Xe,Ze,Qe,$e,et,nt,rt,it,ot;function ct(){Re=new es(M),Re.init(),rt=new wl(M,Re),ze=new Ao(M,Re,e,rt),N=new Sl(M,Re),ze.reversedDepthBuffer&&d&&N.buffers.depth.setReversed(!0),ae=M.createFramebuffer(),se=M.createFramebuffer(),ue=M.createFramebuffer(),Be=new rs(M),P=new nl,F=new Cl(M,Re,N,P,ze,rt,Be),Ve=new $o(A),He=new So(M),it=new Oo(M,He),Ue=new ts(M,He,Be,it),We=new as(M,Ue,He,it,Be),$e=new is(M,ze,F),Xe=new jo(P),Ge=new tl(A,Ve,Re,ze,it,Xe),Ke=new jl(A,P),qe=new ol,Je=new pl(Re),Qe=new Do(A,Ve,N,We,p,s),Ze=new xl(A,We,ze),ot=new Ml(M,Be,ze,N),et=new ko(M,Re,Be),nt=new ns(M,Re,Be),Be.programs=Ge.programs,A.capabilities=ze,A.extensions=Re,A.properties=P,A.renderLists=qe,A.shadowMap=Ze,A.state=N,A.info=Be}ct(),m!==1009&&(ne=new ss(m,t.width,t.height,o,r,i));let lt=new Ol(A,M);this.xr=lt,this.getContext=function(){return M},this.getContextAttributes=function(){return M.getContextAttributes()},this.forceContextLoss=function(){let e=Re.get(`WEBGL_lose_context`);e&&e.loseContext()},this.forceContextRestore=function(){let e=Re.get(`WEBGL_lose_context`);e&&e.restoreContext()},this.getPixelRatio=function(){return Se},this.setPixelRatio=function(e){e!==void 0&&(Se=e,this.setSize(be,xe,!1))},this.getSize=function(e){return e.set(be,xe)},this.setSize=function(e,n,r=!0){if(lt.isPresenting){I(`WebGLRenderer: Can't change size while VR device is presenting.`);return}be=e,xe=n,t.width=Math.floor(e*Se),t.height=Math.floor(n*Se),r===!0&&(t.style.width=e+`px`,t.style.height=n+`px`),ne!==null&&ne.setSize(t.width,t.height),this.setViewport(0,0,e,n)},this.getDrawingBufferSize=function(e){return e.set(be*Se,xe*Se).floor()},this.setDrawingBufferSize=function(e,n,r){be=e,xe=n,Se=r,t.width=Math.floor(e*r),t.height=Math.floor(n*r),this.setViewport(0,0,e,n)},this.setEffects=function(e){if(m===1009){L(`WebGLRenderer: setEffects() requires outputBufferType set to HalfFloatType or FloatType.`);return}if(e){for(let t=0;t<e.length;t++)if(e[t].isOutputPass===!0){I(`WebGLRenderer: OutputPass is not needed in setEffects(). Tone mapping and color space conversion are applied automatically.`);break}}ne.setEffects(e||[])},this.getCurrentViewport=function(e){return e.copy(he)},this.getViewport=function(e){return e.copy(Te)},this.setViewport=function(e,t,n,r){e.isVector4?Te.set(e.x,e.y,e.z,e.w):Te.set(e,t,n,r),N.viewport(he.copy(Te).multiplyScalar(Se).round())},this.getScissor=function(e){return e.copy(Ee)},this.setScissor=function(e,t,n,r){e.isVector4?Ee.set(e.x,e.y,e.z,e.w):Ee.set(e,t,n,r),N.scissor(ge.copy(Ee).multiplyScalar(Se).round())},this.getScissorTest=function(){return De},this.setScissorTest=function(e){N.setScissorTest(De=e)},this.setOpaqueSort=function(e){Ce=e},this.setTransparentSort=function(e){we=e},this.getClearColor=function(e){return e.copy(Qe.getClearColor())},this.setClearColor=function(){Qe.setClearColor(...arguments)},this.getClearAlpha=function(){return Qe.getClearAlpha()},this.setClearAlpha=function(){Qe.setClearAlpha(...arguments)},this.clear=function(e=!0,t=!0,n=!0){let r=0;if(e){let e=!1;if(j!==null){let t=j.texture.format;e=h.has(t)}if(e){let e=j.texture.type,t=g.has(e),n=Qe.getClearColor(),r=Qe.getClearAlpha(),i=n.r,a=n.g,o=n.b;t?(y[0]=i,y[1]=a,y[2]=o,y[3]=r,M.clearBufferuiv(M.COLOR,0,y)):(b[0]=i,b[1]=a,b[2]=o,b[3]=r,M.clearBufferiv(M.COLOR,0,b))}else r|=M.COLOR_BUFFER_BIT}t&&(r|=M.DEPTH_BUFFER_BIT,this.state.buffers.depth.setMask(!0)),n&&(r|=M.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),r!==0&&M.clear(r)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.setNodesHandler=function(e){e.setRenderer(this),ie=e},this.dispose=function(){t.removeEventListener(`webglcontextlost`,dt,!1),t.removeEventListener(`webglcontextrestored`,ft,!1),t.removeEventListener(`webglcontextcreationerror`,pt,!1),Qe.dispose(),qe.dispose(),Je.dispose(),P.dispose(),Ve.dispose(),We.dispose(),it.dispose(),ot.dispose(),Ge.dispose(),lt.dispose(),lt.removeEventListener(`sessionstart`,yt),lt.removeEventListener(`sessionend`,z),B.stop()};function dt(e){e.preventDefault(),st(`WebGLRenderer: Context Lost.`),re=!0}function ft(){st(`WebGLRenderer: Context Restored.`),re=!1;let e=Be.autoReset,t=Ze.enabled,n=Ze.autoUpdate,r=Ze.needsUpdate,i=Ze.type;ct(),Be.autoReset=e,Ze.enabled=t,Ze.autoUpdate=n,Ze.needsUpdate=r,Ze.type=i}function pt(e){L(`WebGLRenderer: A WebGL context could not be created. Reason: `,e.statusMessage)}function mt(e){let t=e.target;t.removeEventListener(`dispose`,mt),ht(t)}function ht(e){gt(e),P.remove(e)}function gt(e){let t=P.get(e).programs;t!==void 0&&(t.forEach(function(e){Ge.releaseProgram(e)}),e.isShaderMaterial&&Ge.releaseShaderCache(e))}this.renderBufferDirect=function(e,t,n,r,i,a){t===null&&(t=Pe);let o=i.isMesh&&i.matrixWorld.determinantAffine()<0,s=Ot(e,t,n,r,i);N.setMaterial(r,o);let c=n.index,l=1;if(r.wireframe===!0){if(c=Ue.getWireframeAttribute(n),c===void 0)return;l=2}let u=n.drawRange,d=n.attributes.position,f=u.start*l,p=(u.start+u.count)*l;a!==null&&(f=Math.max(f,a.start*l),p=Math.min(p,(a.start+a.count)*l)),c===null?d!=null&&(f=Math.max(f,0),p=Math.min(p,d.count)):(f=Math.max(f,0),p=Math.min(p,c.count));let m=p-f;if(m<0||m===1/0)return;it.setup(i,r,s,n,c);let h,g=et;if(c!==null&&(h=He.get(c),g=nt,g.setIndex(h)),i.isMesh)r.wireframe===!0?(N.setLineWidth(r.wireframeLinewidth*Ie()),g.setMode(M.LINES)):g.setMode(M.TRIANGLES);else if(i.isLine){let e=r.linewidth;e===void 0&&(e=1),N.setLineWidth(e*Ie()),i.isLineSegments?g.setMode(M.LINES):i.isLineLoop?g.setMode(M.LINE_LOOP):g.setMode(M.LINE_STRIP)}else i.isPoints?g.setMode(M.POINTS):i.isSprite&&g.setMode(M.TRIANGLES);if(i.isBatchedMesh)if(Re.get(`WEBGL_multi_draw`))g.renderMultiDraw(i._multiDrawStarts,i._multiDrawCounts,i._multiDrawCount);else{let e=i._multiDrawStarts,t=i._multiDrawCounts,n=i._multiDrawCount,a=c?He.get(c).bytesPerElement:1,o=P.get(r).currentProgram.getUniforms();for(let r=0;r<n;r++)o.setValue(M,`_gl_DrawID`,r),g.render(e[r]/a,t[r])}else if(i.isInstancedMesh)g.renderInstances(f,m,i.count);else if(n.isInstancedBufferGeometry){let e=n._maxInstanceCount===void 0?1/0:n._maxInstanceCount,t=Math.min(n.instanceCount,e);g.renderInstances(f,m,t)}else g.render(f,m)};function R(e,t,n){e.transparent===!0&&e.side===2&&e.forceSinglePass===!1?(e.side=1,e.needsUpdate=!0,wt(e,t,n),e.side=0,e.needsUpdate=!0,wt(e,t,n),e.side=2):wt(e,t,n)}this.compile=function(e,t,n=null){n===null&&(n=e),O=Je.get(n),O.init(t),te.push(O),n.traverseVisible(function(e){e.isLight&&e.layers.test(t.layers)&&(O.pushLight(e),e.castShadow&&O.pushShadow(e))}),e!==n&&e.traverseVisible(function(e){e.isLight&&e.layers.test(t.layers)&&(O.pushLight(e),e.castShadow&&O.pushShadow(e))}),O.setupLights();let r=new Set;return e.traverse(function(e){if(!(e.isMesh||e.isPoints||e.isLine||e.isSprite))return;let t=e.material;if(t)if(Array.isArray(t))for(let i=0;i<t.length;i++){let a=t[i];R(a,n,e),r.add(a)}else R(t,n,e),r.add(t)}),O=te.pop(),r},this.compileAsync=function(e,t,n=null){let r=this.compile(e,t,n);return new Promise(t=>{function n(){if(r.forEach(function(e){P.get(e).currentProgram.isReady()&&r.delete(e)}),r.size===0){t(e);return}setTimeout(n,10)}Re.get(`KHR_parallel_shader_compile`)===null?setTimeout(n,10):n()})};let _t=null;function vt(e){_t&&_t(e)}function yt(){B.stop()}function z(){B.start()}let B=new xo;B.setAnimationLoop(vt),typeof self<`u`&&B.setContext(self),this.setAnimationLoop=function(e){_t=e,lt.setAnimationLoop(e),e===null?B.stop():B.start()},lt.addEventListener(`sessionstart`,yt),lt.addEventListener(`sessionend`,z),this.render=function(e,t){if(t!==void 0&&t.isCamera!==!0){L(`WebGLRenderer.render: camera is not an instance of THREE.Camera.`);return}if(re===!0)return;ie!==null&&ie.renderStart(e,t);let n=lt.enabled===!0&&lt.isPresenting===!0,r=ne!==null&&(j===null||n)&&ne.begin(A,j);if(e.matrixWorldAutoUpdate===!0&&e.updateMatrixWorld(),t.parent===null&&t.matrixWorldAutoUpdate===!0&&t.updateMatrixWorld(),lt.enabled===!0&&lt.isPresenting===!0&&(ne===null||ne.isCompositing()===!1)&&(lt.cameraAutoUpdate===!0&&lt.updateCamera(t),t=lt.getCamera()),e.isScene===!0&&e.onBeforeRender(A,e,t,j),O=Je.get(e,te.length),O.init(t),O.state.textureUnits=F.getTextureUnits(),te.push(O),je.multiplyMatrices(t.projectionMatrix,t.matrixWorldInverse),Oe.setFromProjectionMatrix(je,tt,t.reversedDepth),Ae=this.localClippingEnabled,ke=Xe.init(this.clippingPlanes,Ae),w=qe.get(e,k.length),w.init(),k.push(w),lt.enabled===!0&&lt.isPresenting===!0){let e=A.xr.getDepthSensingMesh();e!==null&&bt(e,t,-1/0,A.sortObjects)}bt(e,t,0,A.sortObjects),w.finish(),A.sortObjects===!0&&w.sort(Ce,we,t.reversedDepth),Fe=lt.enabled===!1||lt.isPresenting===!1||lt.hasDepthSensing()===!1,Fe&&Qe.addToRenderList(w,e),this.info.render.frame++,this.info.autoReset===!0&&this.info.reset(),ke===!0&&Xe.beginShadows();let i=O.state.shadowsArray;if(Ze.render(i,e,t),ke===!0&&Xe.endShadows(),(r&&ne.hasRenderPass())===!1){let n=w.opaque,r=w.transmissive;if(O.setupLights(),t.isArrayCamera){let i=t.cameras;if(r.length>0)for(let t=0,a=i.length;t<a;t++){let a=i[t];St(n,r,e,a)}Fe&&Qe.render(e);for(let t=0,n=i.length;t<n;t++){let n=i[t];xt(w,e,n,n.viewport)}}else r.length>0&&St(n,r,e,t),Fe&&Qe.render(e),xt(w,e,t)}j!==null&&fe===0&&(F.updateMultisampleRenderTarget(j),F.updateRenderTargetMipmap(j)),r&&ne.end(A),e.isScene===!0&&e.onAfterRender(A,e,t),it.resetDefaultState(),pe=-1,me=null,te.pop(),te.length>0?(O=te[te.length-1],F.setTextureUnits(O.state.textureUnits),ke===!0&&Xe.setGlobalState(A.clippingPlanes,O.state.camera)):O=null,k.pop(),w=k.length>0?k[k.length-1]:null,ie!==null&&ie.renderEnd()};function bt(e,t,n,r){if(e.visible===!1)return;if(e.layers.test(t.layers)){if(e.isGroup)n=e.renderOrder;else if(e.isLOD)e.autoUpdate===!0&&e.update(t);else if(e.isLightProbeGrid)O.pushLightProbeGrid(e);else if(e.isLight)O.pushLight(e),e.castShadow&&O.pushShadow(e);else if(e.isSprite){if(!e.frustumCulled||Oe.intersectsSprite(e)){r&&Ne.setFromMatrixPosition(e.matrixWorld).applyMatrix4(je);let t=We.update(e),i=e.material;i.visible&&w.push(e,t,i,n,Ne.z,null)}}else if((e.isMesh||e.isLine||e.isPoints)&&(!e.frustumCulled||Oe.intersectsObject(e))){let t=We.update(e),i=e.material;if(r&&(e.boundingSphere===void 0?(t.boundingSphere===null&&t.computeBoundingSphere(),Ne.copy(t.boundingSphere.center)):(e.boundingSphere===null&&e.computeBoundingSphere(),Ne.copy(e.boundingSphere.center)),Ne.applyMatrix4(e.matrixWorld).applyMatrix4(je)),Array.isArray(i)){let r=t.groups;for(let a=0,o=r.length;a<o;a++){let o=r[a],s=i[o.materialIndex];s&&s.visible&&w.push(e,t,s,n,Ne.z,o)}}else i.visible&&w.push(e,t,i,n,Ne.z,null)}}let i=e.children;for(let e=0,a=i.length;e<a;e++)bt(i[e],t,n,r)}function xt(e,t,n,r){let{opaque:i,transmissive:a,transparent:o}=e;O.setupLightsView(n),ke===!0&&Xe.setGlobalState(A.clippingPlanes,n),r&&N.viewport(he.copy(r)),i.length>0&&H(i,t,n),a.length>0&&H(a,t,n),o.length>0&&H(o,t,n),N.buffers.depth.setTest(!0),N.buffers.depth.setMask(!0),N.buffers.color.setMask(!0),N.setPolygonOffset(!1)}function St(e,t,n,r){if((n.isScene===!0?n.overrideMaterial:null)!==null)return;if(O.state.transmissionRenderTarget[r.id]===void 0){let e=Re.has(`EXT_color_buffer_half_float`)||Re.has(`EXT_color_buffer_float`);O.state.transmissionRenderTarget[r.id]=new zt(1,1,{generateMipmaps:!0,type:e?T:v,minFilter:_,samples:Math.max(4,ze.samples),stencilBuffer:i,resolveDepthBuffer:!1,resolveStencilBuffer:!1,colorSpace:U.workingColorSpace})}let a=O.state.transmissionRenderTarget[r.id],o=r.viewport||he;a.setSize(o.z*A.transmissionResolutionScale,o.w*A.transmissionResolutionScale);let s=A.getRenderTarget(),c=A.getActiveCubeFace(),l=A.getActiveMipmapLevel();A.setRenderTarget(a),A.getClearColor(ve),ye=A.getClearAlpha(),ye<1&&A.setClearColor(16777215,.5),A.clear(),Fe&&Qe.render(n);let u=A.toneMapping;A.toneMapping=0;let d=r.viewport;if(r.viewport!==void 0&&(r.viewport=void 0),O.setupLightsView(r),ke===!0&&Xe.setGlobalState(A.clippingPlanes,r),H(e,n,r),F.updateMultisampleRenderTarget(a),F.updateRenderTargetMipmap(a),Re.has(`WEBGL_multisampled_render_to_texture`)===!1){let e=!1;for(let i=0,a=t.length;i<a;i++){let{object:a,geometry:o,material:s,group:c}=t[i];if(s.side===2&&a.layers.test(r.layers)){let t=s.side;s.side=1,s.needsUpdate=!0,Ct(a,n,r,o,s,c),s.side=t,s.needsUpdate=!0,e=!0}}e===!0&&(F.updateMultisampleRenderTarget(a),F.updateRenderTargetMipmap(a))}A.setRenderTarget(s,c,l),A.setClearColor(ve,ye),d!==void 0&&(r.viewport=d),A.toneMapping=u}function H(e,t,n){let r=t.isScene===!0?t.overrideMaterial:null;for(let i=0,a=e.length;i<a;i++){let a=e[i],{object:o,geometry:s,group:c}=a,l=a.material;l.allowOverride===!0&&r!==null&&(l=r),o.layers.test(n.layers)&&Ct(o,t,n,s,l,c)}}function Ct(e,t,n,r,i,a){e.onBeforeRender(A,t,n,r,i,a),e.modelViewMatrix.multiplyMatrices(n.matrixWorldInverse,e.matrixWorld),e.normalMatrix.getNormalMatrix(e.modelViewMatrix),i.onBeforeRender(A,t,n,r,e,a),i.transparent===!0&&i.side===2&&i.forceSinglePass===!1?(i.side=1,i.needsUpdate=!0,A.renderBufferDirect(n,t,r,i,e,a),i.side=0,i.needsUpdate=!0,A.renderBufferDirect(n,t,r,i,e,a),i.side=2):A.renderBufferDirect(n,t,r,i,e,a),e.onAfterRender(A,t,n,r,i,a)}function wt(e,t,n){t.isScene!==!0&&(t=Pe);let r=P.get(e),i=O.state.lights,a=O.state.shadowsArray,o=i.state.version,s=Ge.getParameters(e,i.state,a,t,n,O.state.lightProbeGridArray),c=Ge.getProgramCacheKey(s),l=r.programs;r.environment=e.isMeshStandardMaterial||e.isMeshLambertMaterial||e.isMeshPhongMaterial?t.environment:null,r.fog=t.fog;let u=e.isMeshStandardMaterial||e.isMeshLambertMaterial&&!e.envMap||e.isMeshPhongMaterial&&!e.envMap;r.envMap=Ve.get(e.envMap||r.environment,u),r.envMapRotation=r.environment!==null&&e.envMap===null?t.environmentRotation:e.envMapRotation,l===void 0&&(e.addEventListener(`dispose`,mt),l=new Map,r.programs=l);let d=l.get(c);if(d!==void 0){if(r.currentProgram===d&&r.lightsStateVersion===o)return Et(e,s),d}else s.uniforms=Ge.getUniforms(e),ie!==null&&e.isNodeMaterial&&ie.build(e,n,s),e.onBeforeCompile(s,A),d=Ge.acquireProgram(s,c),l.set(c,d),r.uniforms=s.uniforms;let f=r.uniforms;return(!e.isShaderMaterial&&!e.isRawShaderMaterial||e.clipping===!0)&&(f.clippingPlanes=Xe.uniform),Et(e,s),r.needsLights=At(e),r.lightsStateVersion=o,r.needsLights&&(f.ambientLightColor.value=i.state.ambient,f.lightProbe.value=i.state.probe,f.directionalLights.value=i.state.directional,f.directionalLightShadows.value=i.state.directionalShadow,f.spotLights.value=i.state.spot,f.spotLightShadows.value=i.state.spotShadow,f.rectAreaLights.value=i.state.rectArea,f.ltc_1.value=i.state.rectAreaLTC1,f.ltc_2.value=i.state.rectAreaLTC2,f.pointLights.value=i.state.point,f.pointLightShadows.value=i.state.pointShadow,f.hemisphereLights.value=i.state.hemi,f.directionalShadowMatrix.value=i.state.directionalShadowMatrix,f.spotLightMatrix.value=i.state.spotLightMatrix,f.spotLightMap.value=i.state.spotLightMap,f.pointShadowMatrix.value=i.state.pointShadowMatrix),r.lightProbeGrid=O.state.lightProbeGridArray.length>0,r.currentProgram=d,r.uniformsList=null,d}function Tt(e){if(e.uniformsList===null){let t=e.currentProgram.getUniforms();e.uniformsList=mc.seqWithValue(t.seq,e.uniforms)}return e.uniformsList}function Et(e,t){let n=P.get(e);n.outputColorSpace=t.outputColorSpace,n.batching=t.batching,n.batchingColor=t.batchingColor,n.instancing=t.instancing,n.instancingColor=t.instancingColor,n.instancingMorph=t.instancingMorph,n.skinning=t.skinning,n.morphTargets=t.morphTargets,n.morphNormals=t.morphNormals,n.morphColors=t.morphColors,n.morphTargetsCount=t.morphTargetsCount,n.numClippingPlanes=t.numClippingPlanes,n.numIntersection=t.numClipIntersection,n.vertexAlphas=t.vertexAlphas,n.vertexTangents=t.vertexTangents,n.toneMapping=t.toneMapping}function Dt(e,t){if(e.length===0)return null;if(e.length===1)return e[0].texture===null?null:e[0];S.setFromMatrixPosition(t.matrixWorld);for(let t=0,n=e.length;t<n;t++){let n=e[t];if(n.texture!==null&&n.boundingBox.containsPoint(S))return n}return null}function Ot(e,t,n,r,i){t.isScene!==!0&&(t=Pe),F.resetTextureUnits();let a=t.fog,o=r.isMeshStandardMaterial||r.isMeshLambertMaterial||r.isMeshPhongMaterial?t.environment:null,s=j===null?A.outputColorSpace:j.isXRRenderTarget===!0?j.texture.colorSpace:U.workingColorSpace,c=r.isMeshStandardMaterial||r.isMeshLambertMaterial&&!r.envMap||r.isMeshPhongMaterial&&!r.envMap,l=Ve.get(r.envMap||o,c),u=r.vertexColors===!0&&!!n.attributes.color&&n.attributes.color.itemSize===4,d=!!n.attributes.tangent&&(!!r.normalMap||r.anisotropy>0),f=!!n.morphAttributes.position,p=!!n.morphAttributes.normal,m=!!n.morphAttributes.color,h=0;r.toneMapped&&(j===null||j.isXRRenderTarget===!0)&&(h=A.toneMapping);let g=n.morphAttributes.position||n.morphAttributes.normal||n.morphAttributes.color,_=g===void 0?0:g.length,v=P.get(r),y=O.state.lights;if(ke===!0&&(Ae===!0||e!==me)){let t=e===me&&r.id===pe;Xe.setState(r,e,t)}let b=!1;r.version===v.__version?v.needsLights&&v.lightsStateVersion!==y.state.version?b=!0:v.outputColorSpace===s?i.isBatchedMesh&&v.batching===!1||!i.isBatchedMesh&&v.batching===!0||i.isBatchedMesh&&v.batchingColor===!0&&i.colorTexture===null||i.isBatchedMesh&&v.batchingColor===!1&&i.colorTexture!==null||i.isInstancedMesh&&v.instancing===!1||!i.isInstancedMesh&&v.instancing===!0||i.isSkinnedMesh&&v.skinning===!1||!i.isSkinnedMesh&&v.skinning===!0||i.isInstancedMesh&&v.instancingColor===!0&&i.instanceColor===null||i.isInstancedMesh&&v.instancingColor===!1&&i.instanceColor!==null||i.isInstancedMesh&&v.instancingMorph===!0&&i.morphTexture===null||i.isInstancedMesh&&v.instancingMorph===!1&&i.morphTexture!==null?b=!0:v.envMap===l?r.fog===!0&&v.fog!==a||v.numClippingPlanes!==void 0&&(v.numClippingPlanes!==Xe.numPlanes||v.numIntersection!==Xe.numIntersection)?b=!0:v.vertexAlphas===u&&v.vertexTangents===d&&v.morphTargets===f&&v.morphNormals===p&&v.morphColors===m&&v.toneMapping===h&&v.morphTargetsCount===_?!!v.lightProbeGrid!=O.state.lightProbeGridArray.length>0&&(b=!0):b=!0:b=!0:b=!0:(b=!0,v.__version=r.version);let x=v.currentProgram;b===!0&&(x=wt(r,t,i),ie&&r.isNodeMaterial&&ie.onUpdateProgram(r,x,v));let S=!1,C=!1,w=!1,T=x.getUniforms(),E=v.uniforms;if(N.useProgram(x.program)&&(S=!0,C=!0,w=!0),r.id!==pe&&(pe=r.id,C=!0),v.needsLights){let e=Dt(O.state.lightProbeGridArray,i);v.lightProbeGrid!==e&&(v.lightProbeGrid=e,C=!0)}if(S||me!==e){N.buffers.depth.getReversed()&&e.reversedDepth!==!0&&(e._reversedDepth=!0,e.updateProjectionMatrix()),T.setValue(M,`projectionMatrix`,e.projectionMatrix),T.setValue(M,`viewMatrix`,e.matrixWorldInverse);let t=T.map.cameraPosition;t!==void 0&&t.setValue(M,Me.setFromMatrixPosition(e.matrixWorld)),ze.logarithmicDepthBuffer&&T.setValue(M,`logDepthBufFC`,2/(Math.log(e.far+1)/Math.LN2)),(r.isMeshPhongMaterial||r.isMeshToonMaterial||r.isMeshLambertMaterial||r.isMeshBasicMaterial||r.isMeshStandardMaterial||r.isShaderMaterial)&&T.setValue(M,`isOrthographic`,e.isOrthographicCamera===!0),me!==e&&(me=e,C=!0,w=!0)}if(v.needsLights&&(y.state.directionalShadowMap.length>0&&T.setValue(M,`directionalShadowMap`,y.state.directionalShadowMap,F),y.state.spotShadowMap.length>0&&T.setValue(M,`spotShadowMap`,y.state.spotShadowMap,F),y.state.pointShadowMap.length>0&&T.setValue(M,`pointShadowMap`,y.state.pointShadowMap,F)),i.isSkinnedMesh){T.setOptional(M,i,`bindMatrix`),T.setOptional(M,i,`bindMatrixInverse`);let e=i.skeleton;e&&(e.boneTexture===null&&e.computeBoneTexture(),T.setValue(M,`boneTexture`,e.boneTexture,F))}i.isBatchedMesh&&(T.setOptional(M,i,`batchingTexture`),T.setValue(M,`batchingTexture`,i._matricesTexture,F),T.setOptional(M,i,`batchingIdTexture`),T.setValue(M,`batchingIdTexture`,i._indirectTexture,F),T.setOptional(M,i,`batchingColorTexture`),i._colorsTexture!==null&&T.setValue(M,`batchingColorTexture`,i._colorsTexture,F));let D=n.morphAttributes;if((D.position!==void 0||D.normal!==void 0||D.color!==void 0)&&$e.update(i,n,x),(C||v.receiveShadow!==i.receiveShadow)&&(v.receiveShadow=i.receiveShadow,T.setValue(M,`receiveShadow`,i.receiveShadow)),(r.isMeshStandardMaterial||r.isMeshLambertMaterial||r.isMeshPhongMaterial)&&r.envMap===null&&t.environment!==null&&(E.envMapIntensity.value=t.environmentIntensity),E.dfgLUT!==void 0&&(E.dfgLUT.value=Fl()),C){if(T.setValue(M,`toneMappingExposure`,A.toneMappingExposure),v.needsLights&&kt(E,w),a&&r.fog===!0&&Ke.refreshFogUniforms(E,a),Ke.refreshMaterialUniforms(E,r,Se,xe,O.state.transmissionRenderTarget[e.id]),v.needsLights&&v.lightProbeGrid){let e=v.lightProbeGrid;E.probesSH.value=e.texture,E.probesMin.value.copy(e.boundingBox.min),E.probesMax.value.copy(e.boundingBox.max),E.probesResolution.value.copy(e.resolution)}mc.upload(M,Tt(v),E,F)}if(r.isShaderMaterial&&r.uniformsNeedUpdate===!0&&(mc.upload(M,Tt(v),E,F),r.uniformsNeedUpdate=!1),r.isSpriteMaterial&&T.setValue(M,`center`,i.center),T.setValue(M,`modelViewMatrix`,i.modelViewMatrix),T.setValue(M,`normalMatrix`,i.normalMatrix),T.setValue(M,`modelMatrix`,i.matrixWorld),r.uniformsGroups!==void 0){let e=r.uniformsGroups;for(let t=0,n=e.length;t<n;t++){let n=e[t];ot.update(n,x),ot.bind(n,x)}}return x}function kt(e,t){e.ambientLightColor.needsUpdate=t,e.lightProbe.needsUpdate=t,e.directionalLights.needsUpdate=t,e.directionalLightShadows.needsUpdate=t,e.pointLights.needsUpdate=t,e.pointLightShadows.needsUpdate=t,e.spotLights.needsUpdate=t,e.spotLightShadows.needsUpdate=t,e.rectAreaLights.needsUpdate=t,e.hemisphereLights.needsUpdate=t}function At(e){return e.isMeshLambertMaterial||e.isMeshToonMaterial||e.isMeshPhongMaterial||e.isMeshStandardMaterial||e.isShadowMaterial||e.isShaderMaterial&&e.lights===!0}this.getActiveCubeFace=function(){return de},this.getActiveMipmapLevel=function(){return fe},this.getRenderTarget=function(){return j},this.setRenderTargetTextures=function(e,t,n){let r=P.get(e);r.__autoAllocateDepthBuffer=e.resolveDepthBuffer===!1,r.__autoAllocateDepthBuffer===!1&&(r.__useRenderToTexture=!1),P.get(e.texture).__webglTexture=t,P.get(e.depthTexture).__webglTexture=r.__autoAllocateDepthBuffer?void 0:n,r.__hasExternalTextures=!0},this.setRenderTargetFramebuffer=function(e,t){let n=P.get(e);n.__webglFramebuffer=t,n.__useDefaultFramebuffer=t===void 0},this.setRenderTarget=function(e,t=0,n=0){j=e,de=t,fe=n;let r=null,i=!1,a=!1;if(e){let o=P.get(e);if(o.__useDefaultFramebuffer!==void 0){N.bindFramebuffer(M.FRAMEBUFFER,o.__webglFramebuffer),he.copy(e.viewport),ge.copy(e.scissor),_e=e.scissorTest,N.viewport(he),N.scissor(ge),N.setScissorTest(_e),pe=-1;return}else if(o.__webglFramebuffer===void 0)F.setupRenderTarget(e);else if(o.__hasExternalTextures)F.rebindTextures(e,P.get(e.texture).__webglTexture,P.get(e.depthTexture).__webglTexture);else if(e.depthBuffer){let t=e.depthTexture;if(o.__boundDepthTexture!==t){if(t!==null&&P.has(t)&&(e.width!==t.image.width||e.height!==t.image.height))throw Error(`THREE.WebGLRenderer: Attached DepthTexture is initialized to the incorrect size.`);F.setupDepthRenderbuffer(e)}}let s=e.texture;(s.isData3DTexture||s.isDataArrayTexture||s.isCompressedArrayTexture)&&(a=!0);let c=P.get(e).__webglFramebuffer;e.isWebGLCubeRenderTarget?(r=Array.isArray(c[t])?c[t][n]:c[t],i=!0):r=e.samples>0&&F.useMultisampledRTT(e)===!1?P.get(e).__webglMultisampledFramebuffer:Array.isArray(c)?c[n]:c,he.copy(e.viewport),ge.copy(e.scissor),_e=e.scissorTest}else he.copy(Te).multiplyScalar(Se).floor(),ge.copy(Ee).multiplyScalar(Se).floor(),_e=De;if(n!==0&&(r=ae),N.bindFramebuffer(M.FRAMEBUFFER,r)&&N.drawBuffers(e,r),N.viewport(he),N.scissor(ge),N.setScissorTest(_e),i){let r=P.get(e.texture);M.framebufferTexture2D(M.FRAMEBUFFER,M.COLOR_ATTACHMENT0,M.TEXTURE_CUBE_MAP_POSITIVE_X+t,r.__webglTexture,n)}else if(a){let r=t;for(let t=0;t<e.textures.length;t++){let i=P.get(e.textures[t]);M.framebufferTextureLayer(M.FRAMEBUFFER,M.COLOR_ATTACHMENT0+t,i.__webglTexture,n,r)}}else if(e!==null&&n!==0){let t=P.get(e.texture);M.framebufferTexture2D(M.FRAMEBUFFER,M.COLOR_ATTACHMENT0,M.TEXTURE_2D,t.__webglTexture,n)}pe=-1},this.readRenderTargetPixels=function(e,t,n,r,i,a,o,s=0){if(!(e&&e.isWebGLRenderTarget)){L(`WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.`);return}let c=P.get(e).__webglFramebuffer;if(e.isWebGLCubeRenderTarget&&o!==void 0&&(c=c[o]),c){N.bindFramebuffer(M.FRAMEBUFFER,c);try{let o=e.textures[s],c=o.format,l=o.type;if(e.textures.length>1&&M.readBuffer(M.COLOR_ATTACHMENT0+s),!ze.textureFormatReadable(c)){L(`WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.`);return}if(!ze.textureTypeReadable(l)){L(`WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.`);return}t>=0&&t<=e.width-r&&n>=0&&n<=e.height-i&&M.readPixels(t,n,r,i,rt.convert(c),rt.convert(l),a)}finally{let e=j===null?null:P.get(j).__webglFramebuffer;N.bindFramebuffer(M.FRAMEBUFFER,e)}}},this.readRenderTargetPixelsAsync=async function(e,t,n,r,i,a,o,s=0){if(!(e&&e.isWebGLRenderTarget))throw Error(`THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.`);let c=P.get(e).__webglFramebuffer;if(e.isWebGLCubeRenderTarget&&o!==void 0&&(c=c[o]),c)if(t>=0&&t<=e.width-r&&n>=0&&n<=e.height-i){N.bindFramebuffer(M.FRAMEBUFFER,c);let o=e.textures[s],l=o.format,u=o.type;if(e.textures.length>1&&M.readBuffer(M.COLOR_ATTACHMENT0+s),!ze.textureFormatReadable(l))throw Error(`THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.`);if(!ze.textureTypeReadable(u))throw Error(`THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.`);let d=M.createBuffer();M.bindBuffer(M.PIXEL_PACK_BUFFER,d),M.bufferData(M.PIXEL_PACK_BUFFER,a.byteLength,M.STREAM_READ),M.readPixels(t,n,r,i,rt.convert(l),rt.convert(u),0);let f=j===null?null:P.get(j).__webglFramebuffer;N.bindFramebuffer(M.FRAMEBUFFER,f);let p=M.fenceSync(M.SYNC_GPU_COMMANDS_COMPLETE,0);return M.flush(),await ut(M,p,4),M.bindBuffer(M.PIXEL_PACK_BUFFER,d),M.getBufferSubData(M.PIXEL_PACK_BUFFER,0,a),M.deleteBuffer(d),M.deleteSync(p),a}else throw Error(`THREE.WebGLRenderer.readRenderTargetPixelsAsync: requested read bounds are out of range.`)},this.copyFramebufferToTexture=function(e,t=null,n=0){let r=2**-n,i=Math.floor(e.image.width*r),a=Math.floor(e.image.height*r),o=t===null?0:t.x,s=t===null?0:t.y;F.setTexture2D(e,0),M.copyTexSubImage2D(M.TEXTURE_2D,n,0,0,o,s,i,a),N.unbindTexture()},this.copyTextureToTexture=function(e,t,n=null,r=null,i=0,a=0){let o,s,c,l,u,d,f,p,m,h=e.isCompressedTexture?e.mipmaps[a]:e.image;if(n!==null)o=n.max.x-n.min.x,s=n.max.y-n.min.y,c=n.isBox3?n.max.z-n.min.z:1,l=n.min.x,u=n.min.y,d=n.isBox3?n.min.z:0;else{let t=2**-i;o=Math.floor(h.width*t),s=Math.floor(h.height*t),c=e.isDataArrayTexture?h.depth:e.isData3DTexture?Math.floor(h.depth*t):1,l=0,u=0,d=0}r===null?(f=0,p=0,m=0):(f=r.x,p=r.y,m=r.z);let g=rt.convert(t.format),_=rt.convert(t.type),v;t.isData3DTexture?(F.setTexture3D(t,0),v=M.TEXTURE_3D):t.isDataArrayTexture||t.isCompressedArrayTexture?(F.setTexture2DArray(t,0),v=M.TEXTURE_2D_ARRAY):(F.setTexture2D(t,0),v=M.TEXTURE_2D),N.activeTexture(M.TEXTURE0),N.pixelStorei(M.UNPACK_FLIP_Y_WEBGL,t.flipY),N.pixelStorei(M.UNPACK_PREMULTIPLY_ALPHA_WEBGL,t.premultiplyAlpha),N.pixelStorei(M.UNPACK_ALIGNMENT,t.unpackAlignment);let y=N.getParameter(M.UNPACK_ROW_LENGTH),b=N.getParameter(M.UNPACK_IMAGE_HEIGHT),x=N.getParameter(M.UNPACK_SKIP_PIXELS),S=N.getParameter(M.UNPACK_SKIP_ROWS),C=N.getParameter(M.UNPACK_SKIP_IMAGES);N.pixelStorei(M.UNPACK_ROW_LENGTH,h.width),N.pixelStorei(M.UNPACK_IMAGE_HEIGHT,h.height),N.pixelStorei(M.UNPACK_SKIP_PIXELS,l),N.pixelStorei(M.UNPACK_SKIP_ROWS,u),N.pixelStorei(M.UNPACK_SKIP_IMAGES,d);let w=e.isDataArrayTexture||e.isData3DTexture,T=t.isDataArrayTexture||t.isData3DTexture;if(e.isDepthTexture){let n=P.get(e),r=P.get(t),h=P.get(n.__renderTarget),g=P.get(r.__renderTarget);N.bindFramebuffer(M.READ_FRAMEBUFFER,h.__webglFramebuffer),N.bindFramebuffer(M.DRAW_FRAMEBUFFER,g.__webglFramebuffer);for(let n=0;n<c;n++)w&&(M.framebufferTextureLayer(M.READ_FRAMEBUFFER,M.COLOR_ATTACHMENT0,P.get(e).__webglTexture,i,d+n),M.framebufferTextureLayer(M.DRAW_FRAMEBUFFER,M.COLOR_ATTACHMENT0,P.get(t).__webglTexture,a,m+n)),M.blitFramebuffer(l,u,o,s,f,p,o,s,M.DEPTH_BUFFER_BIT,M.NEAREST);N.bindFramebuffer(M.READ_FRAMEBUFFER,null),N.bindFramebuffer(M.DRAW_FRAMEBUFFER,null)}else if(i!==0||e.isRenderTargetTexture||P.has(e)){let n=P.get(e),r=P.get(t);N.bindFramebuffer(M.READ_FRAMEBUFFER,se),N.bindFramebuffer(M.DRAW_FRAMEBUFFER,ue);for(let e=0;e<c;e++)w?M.framebufferTextureLayer(M.READ_FRAMEBUFFER,M.COLOR_ATTACHMENT0,n.__webglTexture,i,d+e):M.framebufferTexture2D(M.READ_FRAMEBUFFER,M.COLOR_ATTACHMENT0,M.TEXTURE_2D,n.__webglTexture,i),T?M.framebufferTextureLayer(M.DRAW_FRAMEBUFFER,M.COLOR_ATTACHMENT0,r.__webglTexture,a,m+e):M.framebufferTexture2D(M.DRAW_FRAMEBUFFER,M.COLOR_ATTACHMENT0,M.TEXTURE_2D,r.__webglTexture,a),i===0?T?M.copyTexSubImage3D(v,a,f,p,m+e,l,u,o,s):M.copyTexSubImage2D(v,a,f,p,l,u,o,s):M.blitFramebuffer(l,u,o,s,f,p,o,s,M.COLOR_BUFFER_BIT,M.NEAREST);N.bindFramebuffer(M.READ_FRAMEBUFFER,null),N.bindFramebuffer(M.DRAW_FRAMEBUFFER,null)}else T?e.isDataTexture||e.isData3DTexture?M.texSubImage3D(v,a,f,p,m,o,s,c,g,_,h.data):t.isCompressedArrayTexture?M.compressedTexSubImage3D(v,a,f,p,m,o,s,c,g,h.data):M.texSubImage3D(v,a,f,p,m,o,s,c,g,_,h):e.isDataTexture?M.texSubImage2D(M.TEXTURE_2D,a,f,p,o,s,g,_,h.data):e.isCompressedTexture?M.compressedTexSubImage2D(M.TEXTURE_2D,a,f,p,h.width,h.height,g,h.data):M.texSubImage2D(M.TEXTURE_2D,a,f,p,o,s,g,_,h);N.pixelStorei(M.UNPACK_ROW_LENGTH,y),N.pixelStorei(M.UNPACK_IMAGE_HEIGHT,b),N.pixelStorei(M.UNPACK_SKIP_PIXELS,x),N.pixelStorei(M.UNPACK_SKIP_ROWS,S),N.pixelStorei(M.UNPACK_SKIP_IMAGES,C),a===0&&t.generateMipmaps&&M.generateMipmap(v),N.unbindTexture()},this.initRenderTarget=function(e){P.get(e).__webglFramebuffer===void 0&&F.setupRenderTarget(e)},this.initTexture=function(e){e.isCubeTexture?F.setTextureCube(e,0):e.isData3DTexture?F.setTexture3D(e,0):e.isDataArrayTexture||e.isCompressedArrayTexture?F.setTexture2DArray(e,0):F.setTexture2D(e,0),N.unbindTexture()},this.resetState=function(){de=0,fe=0,j=null,N.reset(),it.reset()},typeof __THREE_DEVTOOLS__<`u`&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent(`observe`,{detail:this}))}get coordinateSystem(){return tt}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(e){this._outputColorSpace=e;let t=this.getContext();t.drawingBufferColorSpace=U._getDrawingBufferColorSpace(e),t.unpackColorSpace=U._getUnpackColorSpace()}},Ll=class e{static createButton(t,n={}){let r=document.createElement(`button`);function i(){let e=null;async function i(n){n.addEventListener(`end`,a),await t.xr.setSession(n),r.textContent=`EXIT VR`,e=n}function a(){e.removeEventListener(`end`,a),r.textContent=`ENTER VR`,e=null}r.style.display=``,r.style.cursor=`pointer`,r.style.left=`calc(50% - 50px)`,r.style.width=`100px`,r.textContent=`ENTER VR`;let o={...n,optionalFeatures:[`local-floor`,`bounded-floor`,`layers`,...n.optionalFeatures||[]]};r.onmouseenter=function(){r.style.opacity=`1.0`},r.onmouseleave=function(){r.style.opacity=`0.5`},r.onclick=function(){e===null?navigator.xr.requestSession(`immersive-vr`,o).then(i):(e.end(),navigator.xr.offerSession!==void 0&&navigator.xr.offerSession(`immersive-vr`,o).then(i).catch(e=>{console.warn(e)}))},navigator.xr.offerSession!==void 0&&navigator.xr.offerSession(`immersive-vr`,o).then(i).catch(e=>{console.warn(e)})}function a(){r.style.display=``,r.style.cursor=`auto`,r.style.left=`calc(50% - 75px)`,r.style.width=`150px`,r.onmouseenter=null,r.onmouseleave=null,r.onclick=null}function o(){a(),r.textContent=`VR NOT SUPPORTED`}function s(e){a(),console.warn(`Exception when trying to call xr.isSessionSupported`,e),r.textContent=`VR NOT ALLOWED`}function c(e){e.style.position=`absolute`,e.style.bottom=`20px`,e.style.padding=`12px 6px`,e.style.border=`1px solid #fff`,e.style.borderRadius=`4px`,e.style.background=`rgba(0,0,0,0.1)`,e.style.color=`#fff`,e.style.font=`normal 13px sans-serif`,e.style.textAlign=`center`,e.style.opacity=`0.5`,e.style.outline=`none`,e.style.zIndex=`999`}if(`xr`in navigator)return r.id=`VRButton`,r.style.display=`none`,c(r),navigator.xr.isSessionSupported(`immersive-vr`).then(function(t){t?i():o(),t&&e.xrSessionIsGranted&&r.click()}).catch(s),r;{let e=document.createElement(`a`);return window.isSecureContext===!1?(e.href=document.location.href.replace(/^http:/,`https:`),e.innerHTML=`WEBXR NEEDS HTTPS`):(e.href=`https://immersiveweb.dev/`,e.innerHTML=`WEBXR NOT AVAILABLE`),e.style.left=`calc(50% - 90px)`,e.style.width=`180px`,e.style.textDecoration=`none`,c(e),e}}static registerSessionGrantedListener(){if(typeof navigator<`u`&&`xr`in navigator){if(/WebXRViewer\//i.test(navigator.userAgent))return;navigator.xr.addEventListener(`sessiongranted`,()=>{e.xrSessionIsGranted=!0})}}};Ll.xrSessionIsGranted=!1,Ll.registerSessionGrantedListener();var Rl=class{constructor(e){this.container=e,this.renderer=new Il({antialias:!0,powerPreference:`high-performance`}),this.renderer.setClearColor(329483,1),this.renderer.shadowMap.enabled=!1,this.renderer.outputColorSpace=Ye,this.renderer.toneMapping=4,this.renderer.toneMappingExposure=1.18,this.renderer.xr.enabled=!0,this.renderer.xr.setReferenceSpaceType(`local`),this.renderer.domElement.className=`game-canvas`,this.renderer.domElement.setAttribute(`aria-label`,`Launch3001 gameplay`),e.appendChild(this.renderer.domElement),this.vrButton=Ll.createButton(this.renderer),this.vrButton.classList.add(`vr-entry-button`),e.appendChild(this.vrButton),this.width=1,this.height=1}resize(e){let t=this.container.getBoundingClientRect();this.width=Math.max(1,Math.floor(t.width)),this.height=Math.max(1,Math.floor(t.height)),this.renderer.setPixelRatio(Math.min(window.devicePixelRatio||1,1.8)),this.renderer.setSize(this.width,this.height,!1),e.aspect=this.width/this.height,e.updateProjectionMatrix()}render(e,t){this.renderer.render(e,t)}setAnimationLoop(e){this.renderer.setAnimationLoop(e)}isPresentingXR(){return this.renderer.xr.isPresenting}},zl={settings:`launch3001.settings`,progress:`launch3001.progress`,profile:`launch3001.profile`},Bl=`launch3001`,Vl=`https://bigslickgames.com/login/index.html`,Hl=`https://bigslickgames.com/shop.html`,Ul=`/platform/auth/session`,Wl=[`https://bigslickgames.com`,`https://www.bigslickgames.com`,`http://hub.bsg.local:8080`],Gl={chase:`CHASE`,far:`FAR`,side:`SIDE`,cockpit:`COCKPIT`},Kl=[Gl.chase,Gl.far,Gl.side,Gl.cockpit],ql={cockpit:`VR COCKPIT`,chase:`VR CHASE`,side:`VR SIDE`};ql.cockpit,ql.chase,ql.side;var Jl={perfect:`PERFECT`,excellent:`EXCELLENT`,good:`GOOD`,safe:`SAFE`,hard:`HARD LANDING`,crash:`CRASH`},Yl={tooFast:`TOO FAST`,sideSpeed:`EXCESSIVE SIDE SPEED`,badAngle:`BAD ANGLE`,missedPad:`MISSED PAD`,terrain:`TERRAIN HIT`,roof:`ROOF HIT`,wall:`WALL HIT`,bounds:`OUT OF BOUNDS`},Xl={tiltSensitivity:1,tiltDeadZone:.06,tiltSmoothing:.18,rocketTiltMax:.62,invertForward:!1,volume:.55,muted:!1,cameraMode:Gl.chase,cameraDistance:1,cameraHeight:1,sideCameraSide:1,vrCameraMode:ql.cockpit,vrCameraDistance:2.3,vrCameraHeight:.85,vrPanelDistance:1.85,vrPanelHeight:-.22,vrComfortScale:1,vrSideCameraSide:1,noFuelDrain:!1,debug:!1},Zl=.55,Ql=1.58,$l=1/60,eu=.05;function tu(e,t,n){return Math.max(t,Math.min(n,e))}function nu(e,t,n){return e+(t-e)*tu(n,0,1)}function ru(e,t,n,r){return nu(e,t,1-Math.exp(-n*r))}function iu(e){e.traverse(e=>{e.geometry&&e.geometry.dispose(),(Array.isArray(e.material)?e.material:[e.material]).filter(Boolean).forEach(e=>e.dispose())})}function au(e){let t=new V(e.position.x,e.position.y,e.position.z),n=new V(e.size.x/2,e.size.y/2,e.size.z/2);return new Vn(t.clone().sub(n),t.clone().add(n))}function ou(e,t=1){return Number.isFinite(e)?e.toFixed(t):`0.0`}function su(e,t){if(t.has(e))throw TypeError(`Cannot initialize the same private elements twice on an object`)}function cu(e,t){su(e,t),t.add(e)}function Y(e,t,n){if(typeof e==`function`?e===t:e.has(t))return arguments.length<3?t:n;throw TypeError(`Private element is not present on this object`)}var lu=new WeakSet,uu=class{constructor(){cu(this,lu),this.group=new _n,this.velocity=new V,this.position=this.group.position,this.radius=Zl,this.alive=!0,this.landed=!1,this.thrusting=!1,this.thrustUse=0,this.flightTime=0,this.fuel=100,this.distance=0,this.visualTiltX=0,this.visualTiltZ=0,Y(lu,this,du).call(this)}reset(e){this.position.set(e.x,e.y,e.z),this.velocity.set(0,0,0),this.group.rotation.set(0,0,0),this.alive=!0,this.landed=!1,this.thrusting=!1,this.thrustUse=0,this.flightTime=0,this.fuel=100,this.distance=0,this.setFlame(!1)}updateVisual(e,t,n={}){let r=tu(n.rocketTiltMax??.62,.28,1.2);this.visualTiltZ=ru(this.visualTiltZ,tu(-t.x*r,-r,r),8,e),this.visualTiltX=ru(this.visualTiltX,tu(t.z*r*.82,-r,r),8,e),this.group.rotation.z=this.visualTiltZ,this.group.rotation.x=this.visualTiltX,this.flame&&(this.flame.scale.y=this.thrusting?.8+Math.random()*.35:.001,this.flame.scale.x=this.thrusting?.85+Math.random()*.2:.001,this.flame.scale.z=this.flame.scale.x,this.innerFlame.scale.y=this.thrusting?.65+Math.random()*.22:.001,this.glow.intensity=this.thrusting?1.8:0,this.engineHalo.material.opacity=this.thrusting?.32+Math.random()*.16:0)}setFlame(e){this.thrusting=e,this.flame&&(this.flame.visible=e)}getTiltAngle(){return Math.sqrt(this.group.rotation.x**2+this.group.rotation.z**2)}};function du(){let e=new ma({color:15265269,metalness:.55,roughness:.28,emissive:1120295,emissiveIntensity:.12}),t=new ma({color:16742950,emissive:16727040,emissiveIntensity:1.15,metalness:.2,roughness:.3}),n=new ma({color:1120547,metalness:.38,roughness:.42}),r=new ma({color:1562879,emissive:559274,emissiveIntensity:.8}),i=new K(new Gi(.34,.42,1.8,18),e);i.position.y=.15,this.group.add(i);let a=new K(new Ki(.34,.64,18),t);a.position.y=1.37,this.group.add(a);let o=new K(new Gi(.28,.32,.42,16),n);o.position.y=-.95,this.group.add(o);for(let e=0;e<4;e+=1){let n=new K(new Ui(.12,.48,.42),t);n.position.set(Math.cos(e*Math.PI/2)*.42,-.58,Math.sin(e*Math.PI/2)*.42),n.rotation.y=e*Math.PI/2,this.group.add(n)}for(let e=0;e<3;e+=1){let t=new K(new Gi(.025,.025,.75,8),n);t.position.set(Math.cos(e*Math.PI*2/3)*.5,-1.18,Math.sin(e*Math.PI*2/3)*.5),t.rotation.z=Math.cos(e*Math.PI*2/3)*.36,t.rotation.x=-Math.sin(e*Math.PI*2/3)*.36,this.group.add(t)}let s=new K(new ta(.36,.018,8,24),r);s.position.y=.48,s.rotation.x=Math.PI/2,this.group.add(s);let c=new K(new ea(.13,16,10),new ma({color:6023679,emissive:1886463,emissiveIntensity:1.2,roughness:.18}));c.position.set(0,.82,-.31),c.scale.set(1,.75,.28),this.group.add(c),this.flame=new K(new Ki(.2,.9,16),new Yr({color:16751150,transparent:!0,opacity:.82})),this.flame.position.y=-1.55,this.flame.rotation.x=Math.PI,this.flame.visible=!1,this.group.add(this.flame),this.innerFlame=new K(new Ki(.1,.62,12),new Yr({color:16773544,transparent:!0,opacity:.9,blending:2})),this.innerFlame.position.y=-1.48,this.innerFlame.rotation.x=Math.PI,this.flame.add(this.innerFlame),this.engineHalo=new K(new $i(.24,.48,28),new Yr({color:16742946,transparent:!0,opacity:0,side:2,blending:2})),this.engineHalo.position.y=-1.18,this.engineHalo.rotation.x=Math.PI/2,this.group.add(this.engineHalo),this.glow=new Ja(16738816,0,4),this.glow.position.y=-1.25,this.group.add(this.glow)}var fu=new WeakSet,pu=class{constructor(e,t){cu(this,fu),this.target=e,this.settings=t,this.thrust=!1,this.keyboard=new Set,this.keyboardSteering={x:0,z:0},this.rawTilt={x:0,z:0},this.smoothed={x:0,z:0},this.calibration={beta:0,gamma:0},this.permissionState=`idle`,this.error=``,this.hasMotion=!1,Y(fu,this,mu).call(this)}getSteering(){let e=this.keyboardSteering.x+this.smoothed.x,t=this.keyboardSteering.z+this.smoothed.z;return{x:tu(e,-1,1),z:tu(t,-1,1)}}async enableTilt(){try{return typeof DeviceOrientationEvent<`u`&&typeof DeviceOrientationEvent.requestPermission==`function`&&await DeviceOrientationEvent.requestPermission()!==`granted`?(this.permissionState=`denied`,this.error=`Tilt permission denied`,!1):(this.permissionState=`granted`,window.addEventListener(`deviceorientation`,this.onOrientation,{passive:!0}),!0)}catch(e){return this.permissionState=`denied`,this.error=e?.message??`Tilt unavailable`,!1}}calibrate(){this.calibration.beta=this.lastBeta??0,this.calibration.gamma=this.lastGamma??0}update(){let e=tu(this.settings.tiltSmoothing,.02,.9);this.smoothed.x=nu(this.smoothed.x,this.rawTilt.x,e),this.smoothed.z=nu(this.smoothed.z,this.rawTilt.z,e);let t=Y(fu,this,hu).call(this);this.keyboardSteering.x=nu(this.keyboardSteering.x,t.x,.32),this.keyboardSteering.z=nu(this.keyboardSteering.z,t.z,.32)}consumeAction(e){return this.actions?.has(e)?(this.actions.delete(e),!0):!1}destroy(){window.removeEventListener(`deviceorientation`,this.onOrientation)}};function mu(){this.actions=new Set;let e=e=>{e.pointerType===`mouse`&&e.button!==0||e.pointerType!==`touch`&&(e.preventDefault(),this.thrust=!0)},t=e=>{e.pointerType!==`touch`&&(e.preventDefault(),this.thrust=!1)};this.target.addEventListener(`pointerdown`,e,{passive:!1}),this.target.addEventListener(`pointerup`,t,{passive:!1}),this.target.addEventListener(`pointercancel`,t,{passive:!1}),this.target.addEventListener(`pointerleave`,t,{passive:!1}),this.target.addEventListener(`contextmenu`,e=>e.preventDefault()),window.addEventListener(`keydown`,e=>{let t=e.key.toLowerCase();this.keyboard.add(t),Y(fu,this,gu).call(this,t)&&(this.thrust=!0),[`r`,`c`,`escape`].includes(t)&&this.actions.add(t),[` `,`shift`,`enter`,`z`,`x`,`arrowleft`,`arrowright`,`arrowup`,`arrowdown`].includes(t)&&e.preventDefault()}),window.addEventListener(`keyup`,e=>{let t=e.key.toLowerCase();this.keyboard.delete(t),Y(fu,this,gu).call(this,t)&&![...this.keyboard].some(e=>Y(fu,this,gu).call(this,e))&&(this.thrust=!1)}),this.onOrientation=e=>{this.hasMotion=!0,this.lastBeta=e.beta??0,this.lastGamma=e.gamma??0;let t=this.lastBeta-this.calibration.beta,n=this.lastGamma-this.calibration.gamma,r=screen.orientation?.angle??window.orientation??0,i=n/28,a=t/34;r===90?(i=t/34,a=-n/28):r===-90||r===270?(i=-t/34,a=n/28):r===180&&(i=-n/28,a=-t/34),this.settings.invertForward&&(a*=-1);let o=this.settings.tiltDeadZone;i=Math.abs(i)<o?0:i,a=Math.abs(a)<o?0:a,this.rawTilt.x=tu(i*this.settings.tiltSensitivity,-1,1),this.rawTilt.z=tu(a*this.settings.tiltSensitivity,-1,1)}}function hu(){let e=0,t=0;(this.keyboard.has(`arrowleft`)||this.keyboard.has(`a`)||this.keyboard.has(`j`))&&--e,(this.keyboard.has(`arrowright`)||this.keyboard.has(`d`)||this.keyboard.has(`l`))&&(e+=1),(this.keyboard.has(`arrowup`)||this.keyboard.has(`w`)||this.keyboard.has(`i`))&&--t,(this.keyboard.has(`arrowdown`)||this.keyboard.has(`s`)||this.keyboard.has(`k`))&&(t+=1);let n=Math.hypot(e,t);return n>1&&(e/=n,t/=n),{x:e,z:t}}function gu(e){return e===` `||e===`shift`||e===`enter`||e===`z`||e===`x`}var _u=new WeakSet,vu=class{constructor(){cu(this,_u),this.tmpWind=new V}step(e,t,n,r,i,a={}){if(!i||!e.alive||e.landed)return;let o=this.tmpWind.set(t.windDirection.x,t.windDirection.y??0,t.windDirection.z).normalize().multiplyScalar(t.windStrength);e.velocity.y+=t.gravity*r,e.velocity.x+=(n.x*t.steeringPower+o.x)*r,e.velocity.z+=(n.z*t.steeringPower+o.z)*r,e.thrusting&&e.fuel>0&&(e.velocity.y+=t.thrustPower*r,e.thrustUse+=r,a.noFuelDrain||(e.fuel=tu(e.fuel-t.fuelBurnRate*r,0,100))),e.velocity.multiplyScalar(t.damping**(r*60)),e.velocity.x=tu(e.velocity.x,-t.maxSpeed.horizontal,t.maxSpeed.horizontal),e.velocity.z=tu(e.velocity.z,-t.maxSpeed.horizontal,t.maxSpeed.horizontal),e.velocity.y=tu(e.velocity.y,-t.maxSpeed.verticalDown,t.maxSpeed.verticalUp),e.position.addScaledVector(e.velocity,r);let s=Y(_u,this,yu).call(this,e,t),c=s.height+(s.pad?Ql:e.radius);e.position.y<c&&(e.position.y=c,e.velocity.y<0&&(e.velocity.y=0)),e.flightTime+=r,e.distance=Math.max(0,(t.startDistance??0)+t.launchPad.position.z-e.position.z)}};function yu(e,t){let n=t.checkpoints?.find(t=>Math.abs(e.position.x-t.position.x)<=t.size.x/2&&Math.abs(e.position.z-t.position.z)<=t.size.z/2)??t.launchPad,r=Math.abs(e.position.x-t.launchPad.position.x)<=t.launchPad.size.x/2&&Math.abs(e.position.z-t.launchPad.position.z)<=t.launchPad.size.z/2,i=Math.abs(e.position.x-n.position.x)<=n.size.x/2&&Math.abs(e.position.z-n.position.z)<=n.size.z/2;return r||i?{height:n.position.y+.12,pad:!0}:{height:-1/0,pad:!1}}var bu=class{constructor(e,t){this.camera=e,this.settings=t,this.mode=t.cameraMode??Gl.chase,this.position=new V(0,4,8),this.lookAt=new V,this.desired=new V,this.desiredLook=new V,this.shake=0}toggle(){let e=Kl.indexOf(this.mode);return this.mode=Kl[(e+1)%Kl.length],this.mode}setMode(e){Kl.includes(e)&&(this.mode=e)}addShake(e){this.shake=Math.max(this.shake,e)}update(e,t){let n=e.velocity.length(),r=this.settings.cameraDistance??1,i=this.settings.cameraHeight??1;if(this.mode===Gl.chase)this.desired.set(e.position.x,e.position.y+3.2*i,e.position.z+(8.5+n*.12)*r),this.desiredLook.set(e.position.x,e.position.y+.7,e.position.z-5-n*.18);else if(this.mode===Gl.far)this.desired.set(e.position.x,e.position.y+5.2*i,e.position.z+(14+n*.16)*r),this.desiredLook.set(e.position.x,e.position.y+.9,e.position.z-7-n*.22);else if(this.mode===Gl.side){let t=this.settings.sideCameraSide??1;this.desired.set(e.position.x+10.5*t*r,e.position.y+3.6*i,e.position.z+3.8),this.desiredLook.set(e.position.x,e.position.y+.7,e.position.z-4.8-n*.12)}else this.mode===Gl.cockpit&&(this.desired.set(e.position.x,e.position.y+.8,e.position.z+.9),this.desiredLook.set(e.position.x,e.position.y+.4,e.position.z-8));this.position.x=ru(this.position.x,this.desired.x,5.5,t),this.position.y=ru(this.position.y,this.desired.y,5.5,t),this.position.z=ru(this.position.z,this.desired.z,5.5,t),this.lookAt.x=ru(this.lookAt.x,this.desiredLook.x,7,t),this.lookAt.y=ru(this.lookAt.y,this.desiredLook.y,7,t),this.lookAt.z=ru(this.lookAt.z,this.desiredLook.z,7,t),this.shake=Math.max(0,this.shake-t*2.2);let a=this.shake>0?(Math.random()-.5)*this.shake:0;this.camera.position.copy(this.position),this.camera.position.x+=a,this.camera.position.y+=a*.5;let o=this.mode===Gl.far?64:this.mode===Gl.side?60:58;this.camera.fov=ru(this.camera.fov,o+Math.min(n*1.1,8),4,t),this.camera.updateProjectionMatrix(),this.camera.lookAt(this.lookAt)}},xu=new WeakSet,Su=class{constructor(){cu(this,xu)}build(e){let t=new _n;t.name=`Level ${e.id}: ${e.name}`;let n=Y(xu,this,Cu).call(this,e);t.add(n.mesh);let r=Y(xu,this,Tu).call(this,e.launchPad,2406399,`Launch`),i=Y(xu,this,Tu).call(this,e.landingPad,3407754,`Save Marker`),a=new _n;for(let t of e.checkpoints??[e.landingPad])a.add(Y(xu,this,Du).call(this,t));t.add(r,a);let o=[],s=[...e.obstacles,...e.roofs,...e.walls,...e.tunnels??[],...e.movers??[]];s.forEach(e=>{let n=Y(xu,this,Eu).call(this,e);o.push(n),t.add(n)});let c=new _n;for(let t of e.pickups??[])c.add(Y(xu,this,Au).call(this,t));return t.add(c,Y(xu,this,Mu).call(this,e.worldBounds),Y(xu,this,Pu).call(this,e),Y(xu,this,Fu).call(this,e),Y(xu,this,Nu).call(this,e)),{group:t,terrain:n,launchPad:r,landingPad:i,obstacleMeshes:o,pickupMeshes:c.children,checkpointMeshes:a.children,boxes:s.map((e,t)=>({spec:e,mesh:o[t],box:au(e),origin:{...e.position}}))}}};function Cu(e){let{width:t,depth:n,segments:r,amplitude:i,frequency:a,seed:o,centerZ:s=0,startDistance:c=0}=e.terrain,l=new Qi(t,n,r,r);l.rotateX(-Math.PI/2);let u=l.attributes.position,d=[];for(let n=0;n<=r;n+=1){d[n]=[];for(let l=0;l<=r;l+=1){let f=n*(r+1)+l,p=u.getX(f),m=u.getZ(f),h=m+s,g=Y(xu,this,wu).call(this,p,h,e.launchPad,5),_=(e.checkpoints??[e.landingPad]).some(e=>Y(xu,this,wu).call(this,p,h,e,6)),v=Math.max(0,c+e.launchPad.position.z-h),y=Math.min(2.4,.18+v/1500),b=Math.sin((p+o)*a)*Math.cos((m-o)*a*.72),x=Math.sin((p*.31+m*.19+o)*a*1.7),S=Math.sin((p*.47-m*.23+o)*a*3.1)*.22,C=Math.max(0,Math.abs(p)/(t/2)-.42)**2.2*(4.2+y*4.6),w=Math.max(0,1-Math.abs(p)/16)*y*-.18,T=(b*.65+x*.35+S)*i*(.85+y*.82)+C+w;(g||_)&&(T=-.06),u.setY(f,T),d[n][l]=T}}l.computeVertexNormals();let f=new K(l,new ma({color:e.visualTheme.terrain,roughness:.88,metalness:.12,emissive:663600,emissiveIntensity:.32,flatShading:!1}));f.position.z=s,f.receiveShadow=!1;let p=new Ai(new na(l),new vi({color:2060178,transparent:!0,opacity:.28}));return f.add(p),{mesh:f,width:t,depth:n,segments:r,heights:d,centerZ:s}}function wu(e,t,n,r){return Math.abs(e-n.position.x)<n.size.x/2+r&&Math.abs(t-n.position.z)<n.size.z/2+r}function Tu(e,t,n){let r=new _n;r.name=n,r.position.set(e.position.x,e.position.y,e.position.z);let i=new K(new Ui(e.size.x,.18,e.size.z),new ma({color:t,emissive:t,emissiveIntensity:.55,roughness:.28,metalness:.22}));r.add(i);let a=new K(new Ui(e.size.x+.35,.03,e.size.z+.35),new Yr({color:t,transparent:!0,opacity:.2,blending:2}));a.position.y=.13,r.add(a);let o=new K(new $i(Math.min(e.size.x,e.size.z)*.24,Math.min(e.size.x,e.size.z)*.34,36),new Yr({color:t,side:2,transparent:!0,opacity:.95}));return o.rotation.x=-Math.PI/2,o.position.y=.12,r.add(o),r}function Eu(e){let t=e.type===`tunnel`?2416639:e.type===`roof`?16724815:e.type===`caveRoof`?5466501:e.type===`wall`||e.type===`movingWall`?16720947:e.type===`mountain`||e.type===`caveSpike`?9083047:16747044,n=new _n;n.position.set(e.position.x,e.position.y,e.position.z),n.name=e.type;let r=new ma({color:t,emissive:t,emissiveIntensity:.58,transparent:!0,opacity:.97,roughness:.34,metalness:.18}),i=new K(e.type===`spire`||e.type===`movingSpire`||e.type===`mountain`||e.type===`caveSpike`?new Ki(Math.max(e.size.x,e.size.z)*.55,e.size.y,7):new Ui(e.size.x,e.size.y,e.size.z),r);i.name=`${e.type} core`,e.type===`caveSpike`&&(i.rotation.z=Math.PI),n.add(i);let a=new Ai(new Zi(i.geometry),new vi({color:e.type===`mountain`||e.type===`caveSpike`?10483711:16760970,transparent:!0,opacity:.62}));if(i.add(a),e.type!==`roof`&&e.type!==`caveRoof`&&e.type!==`tunnel`&&e.type!==`mountain`&&e.type!==`caveSpike`){let t=new K(new ta(Math.max(e.size.x,e.size.z)*.35,.055,8,22),new Yr({color:16765286,transparent:!0,opacity:.75}));t.position.y=e.size.y*.5,t.rotation.x=Math.PI/2,n.add(t)}if(e.type===`wall`){for(let t=-2;t<=2;t+=1){let r=new K(new Ui(.16,e.size.y*.82,e.size.z+.04),new Yr({color:16765286,transparent:!0,opacity:.7}));r.position.x=t*e.size.x*.16,n.add(r)}let t=new Yr({color:2416639,transparent:!0,opacity:.68,blending:2}),r=new K(new Ui(e.size.x+.12,.08,e.size.z+.08),t),i=r.clone();r.position.y=e.size.y*.5+.04,i.position.y=-e.size.y*.5-.04,n.add(r,i)}if(e.type===`tunnel`){let t=new K(new Ui(e.size.x+.08,e.size.y+.08,.08),new Yr({color:10483711,transparent:!0,opacity:.58}));t.position.z=-e.size.z/2,n.add(t);let r=t.clone();r.position.z=e.size.z/2,n.add(r)}if(e.type===`caveRoof`)for(let t=-2;t<=2;t+=1){let r=new K(new Ui(e.size.x+.1,.05,.08),new Yr({color:2416639,transparent:!0,opacity:.38}));r.position.z=t*e.size.z*.18,r.position.y=-e.size.y*.52,n.add(r)}return n}function Du(e){let t=Y(xu,this,Tu).call(this,e,3407754,`Save ${e.id}`),n=new ma({color:2228180,emissive:1029262,emissiveIntensity:1.1,roughness:.24}),r=new K(new Gi(.08,.08,3.2,10),n),i=r.clone(),a=new K(new Ui(e.size.x+.6,.16,.16),n);return r.position.set(-e.size.x*.5,1.65,0),i.position.set(e.size.x*.5,1.65,0),a.position.set(0,3.25,0),t.add(r,i,a,Y(xu,this,Ou).call(this,e)),t}function Ou(e){let t=document.createElement(`canvas`);t.width=256,t.height=128;let n=t.getContext(`2d`);n.clearRect(0,0,t.width,t.height),n.fillStyle=`rgba(4, 12, 20, 0.72)`,n.strokeStyle=`#33ff8a`,n.lineWidth=8,Y(xu,this,ku).call(this,n,42,18,172,92,22),n.fill(),n.stroke(),n.shadowColor=`#33ff8a`,n.shadowBlur=18,n.fillStyle=`#eafff5`,n.font=`700 64px Arial, sans-serif`,n.textAlign=`center`,n.textBaseline=`middle`,n.fillText(String(e.id),128,66);let r=new zi(t);r.needsUpdate=!0;let i=new zr(new Tr({map:r,transparent:!0,depthWrite:!1}));return i.name=`Save ${e.id} number`,i.position.set(0,4.35,0),i.scale.set(2.7,1.35,1),i}function ku(e,t,n,r,i,a){e.beginPath(),e.moveTo(t+a,n),e.lineTo(t+r-a,n),e.quadraticCurveTo(t+r,n,t+r,n+a),e.lineTo(t+r,n+i-a),e.quadraticCurveTo(t+r,n+i,t+r-a,n+i),e.lineTo(t+a,n+i),e.quadraticCurveTo(t,n+i,t,n+i-a),e.lineTo(t,n+a),e.quadraticCurveTo(t,n,t+a,n),e.closePath()}function Au(e){let t=new _n;if(t.name=`Drop ${e.id}`,t.position.set(e.position.x,e.position.y,e.position.z),e.type===`refill`)return Y(xu,this,ju).call(this,t);let n=new ma({color:5105407,emissive:1554687,emissiveIntensity:1.5,roughness:.18,metalness:.1}),r=new K(new ea(.48,18,14),n);r.scale.set(.72,1.15,.72);let i=new K(new Ki(.32,.75,18),n);i.position.y=-.55,i.rotation.x=Math.PI;let a=new K(new ta(.82,.035,8,34),new Yr({color:10483711,transparent:!0,opacity:.72,blending:2}));return a.rotation.x=Math.PI/2,t.add(r,i,a),t}function ju(e){let t=new ma({color:6750106,emissive:2424698,emissiveIntensity:1.65,roughness:.18,metalness:.1}),n=new K(new ea(.5,18,14),t);n.scale.set(.72,1.18,.72);let r=new K(new Ki(.34,.78,18),t);r.position.y=-.58,r.rotation.x=Math.PI;let i=new Yr({color:15400863,transparent:!0,opacity:.86,blending:2}),a=new K(new Ui(.52,.07,.07),i),o=new K(new Ui(.07,.52,.07),i);a.position.z=.42,o.position.z=.42;let s=new K(new ta(.84,.035,8,34),new Yr({color:10485703,transparent:!0,opacity:.72,blending:2}));s.rotation.x=Math.PI/2;let c=s.clone();return c.scale.set(1.22,1.22,1.22),c.material=s.material.clone(),c.material.opacity=.32,e.add(n,r,a,o,s,c),e}function Mu(e){let t=new _n,n=new vi({color:1670143}),r=[new V(e.minX,.1,e.minZ),new V(e.maxX,.1,e.minZ),new V(e.maxX,.1,e.maxZ),new V(e.minX,.1,e.maxZ),new V(e.minX,.1,e.minZ)];return t.add(new Ei(new yr().setFromPoints(r),n)),t}function Nu(e){let t=new _n,n=new yr,r=[],i=[],a=new W,o=(e.terrain.seed??1)*9973,s=()=>(o=o*1664525+1013904223>>>0,o/4294967296);for(let e=0;e<180;e+=1)r.push((s()-.5)*140,18+s()*44,-36-s()*70),a.setHex(e%5==0?2416639:12113919),i.push(a.r,a.g,a.b);return n.setAttribute(`position`,new G(r,3)),n.setAttribute(`color`,new G(i,3)),t.add(new Ii(n,new ji({size:.12,vertexColors:!0,transparent:!0,opacity:.9}))),t}function Pu(e){let t=new _n,n=new Yr({color:2416639,transparent:!0,opacity:.62}),r=e.checkpoints??[e.landingPad];for(let e of r){let r=e.position.x,i=e.position.z,a=new K(new $i(.28,.34,20),n);a.rotation.x=-Math.PI/2,a.position.set(r,.18,i),t.add(a)}return t}function Fu(e){let t=new _n,n=new Yr({color:530215,transparent:!0,opacity:.85});for(let r=0;r<24;r+=1){let i=2+(r*17+e.terrain.seed)%8,a=new K(new Ui(1.2,i,1.2),n);a.position.set(-34+r*3,i/2-.5,-52-r%4*5),t.add(a)}return t}var Iu=new WeakSet,Lu=class{constructor(e){cu(this,Iu),this.scene=e,this.builder=new Su,this.current=null,this.scene.background=new W(330258),this.scene.fog=new Tn(529698,.012),Y(Iu,this,Ru).call(this)}load(e){return this.current&&(this.scene.remove(this.current.group),iu(this.current.group)),this.current=this.builder.build(e),this.scene.add(this.current.group),this.current}updateMovingHazards(e){if(this.current?.boxes)for(let t of this.current.boxes){if(!t.spec.motion||!t.mesh)continue;let n=e*(t.spec.speed??1)+(t.spec.phase??0);t.spec.position.x=t.origin.x,t.spec.position.y=t.origin.y,t.spec.position.z=t.origin.z,t.spec.motion===`slideX`?t.spec.position.x=t.origin.x+Math.sin(n)*(t.spec.amplitude??6):t.spec.motion===`bobY`?t.spec.position.y=t.origin.y+Math.sin(n)*(t.spec.amplitude??2):t.spec.motion===`slideZ`&&(t.spec.position.z=t.origin.z+Math.sin(n)*(t.spec.amplitude??8)),t.mesh.position.set(t.spec.position.x,t.spec.position.y,t.spec.position.z),t.box.copy(au(t.spec))}}getTerrainHeight(e,t){let n=this.current.terrain,r=n.width/2,i=n.depth/2,a=(e+r)/n.width,o=(t-(n.centerZ??0)+i)/n.depth;if(a<0||a>1||o<0||o>1)return-1/0;let s=a*n.segments,c=o*n.segments,l=Math.floor(s),u=Math.floor(c),d=Math.min(n.segments,l+1),f=Math.min(n.segments,u+1),p=s-l,m=c-u,h=n.heights[u][l],g=n.heights[u][d],_=n.heights[f][l],v=n.heights[f][d];return(h*(1-p)+g*p)*(1-m)+(_*(1-p)+v*p)*m}};function Ru(){this.scene.add(new Pa(12115199,1905440,1.45));let e=new Za(14873855,1.65);e.position.set(-7,13,9),this.scene.add(e);let t=new Za(2416639,.85);t.position.set(9,7,-12),this.scene.add(t);let n=new Ja(2416639,1.05,52);n.position.set(0,8,-12),this.scene.add(n)}var zu=new WeakSet,Bu=class{constructor(e){cu(this,zu),this.world=e,this.tmpSphere=new dr}check(e,t){if(!e.alive||e.landed)return null;let n=e.position,r=t.worldBounds;if(n.x<r.minX||n.x>r.maxX||n.y>r.maxY||n.z<r.minZ||n.z>r.maxZ)return{type:`crash`,reason:Yl.bounds};this.tmpSphere.center.copy(n),this.tmpSphere.radius=e.radius;for(let e of this.world.current.boxes)if(e.box.intersectsSphere(this.tmpSphere))return{type:`crash`,reason:e.spec.type===`roof`?Yl.roof:Yl.wall};for(let r of t.checkpoints??[t.landingPad]){let i=Y(zu,this,Vu).call(this,n,r),a=r.position.y+.12;if(i&&n.y-1.58<=a+.08&&e.velocity.y<=0)return n.y=a+Ql,Y(zu,this,Hu).call(this,e,t,r)}let i=this.world.getTerrainHeight(n.x,n.z);return n.y-e.radius<=i+.05?(n.y=i+e.radius,{type:`crash`,reason:Yl.terrain}):null}};function Vu(e,t){return Math.abs(e.x-t.position.x)<=t.size.x/2&&Math.abs(e.z-t.position.z)<=t.size.z/2}function Hu(e,t,n){let r=t.landingThresholds,i=Math.abs(e.velocity.y),a=Math.hypot(e.velocity.x,e.velocity.z),o=e.getTiltAngle();if(i>r.verticalSpeed)return{type:`crash`,reason:Yl.tooFast};if(a>r.horizontalSpeed)return{type:`crash`,reason:Yl.sideSpeed};if(o>r.angle)return{type:`crash`,reason:Yl.badAngle};let s=Jl.safe;return i<r.verticalSpeed*.32&&a<r.horizontalSpeed*.32&&o<r.angle*.32?s=Jl.perfect:i<r.verticalSpeed*.48&&a<r.horizontalSpeed*.5&&o<r.angle*.5?s=Jl.excellent:i<r.verticalSpeed*.7&&a<r.horizontalSpeed*.72&&o<r.angle*.72&&(s=Jl.good),{type:`landed`,grade:s,marker:n}}var Uu=5400,Wu=180,Gu=new WeakSet,Ku=class{constructor(){cu(this,Gu),this.level=Y(Gu,this,qu).call(this,0),this.levels=[{id:1,name:`Launch`,startDistance:0,markerId:0},{id:2,name:`Marker 3`,startDistance:Wu*3,markerId:3},{id:3,name:`Marker 6`,startDistance:Wu*6,markerId:6},{id:4,name:`Marker 10`,startDistance:Wu*10,markerId:10},{id:5,name:`Marker 15`,startDistance:Wu*15,markerId:15}],this.index=0}get current(){return this.level}getById(e){return this.levels.find(t=>t.id===e)??this.levels[0]}load(e=1){this.index=Math.max(0,this.levels.findIndex(t=>t.id===e));let t=this.getById(e);return this.level=Y(Gu,this,qu).call(this,t.startDistance,t.markerId??0),this.level}next(){return this.level}};function qu(e,t=0){let n=18-e,r=t>0?Y(Gu,this,Yu).call(this,t):0,i=[],a=[],o=[],s=[],c=[],l=[],u=[],d=[],f=Math.floor((Uu-e)/Wu);for(let e=1;e<=f;e+=1){let f=t+e,p=f*Wu,m=Y(Gu,this,Ju).call(this,p),h=n-e*Wu,g=Y(Gu,this,Yu).call(this,f),_=i[e-2]??{position:{x:r,z:n}};i.push({id:f,distance:p,position:{x:g,y:.12,z:h},size:{x:6.6,y:.2,z:6.6}}),d.push({routeX:g,z:h,width:9.4,bottom:0,top:7.2,depth:13}),d.push(Y(Gu,this,Xu).call(this,{walls:s,roofs:c,routeX:_.position.x+(g-_.position.x)*.58,z:h+Wu*.48,difficulty:m,firstGate:e===1,gateIndex:f})),[{suffix:7,zOffset:24,xOffset:-1.8},{suffix:8,zOffset:-24,xOffset:1.8}].forEach(e=>{a.push({id:f*10+e.suffix,type:`instant`,amount:25,position:{x:g+e.xOffset,y:1.8+Math.sin(f*.8+e.suffix)*1.2+m*1.8,z:h+e.zOffset},radius:1.2})}),[-.72,-.5,-.26,-.04,.18,.38,.58,.78].forEach((e,t)=>{let n=Math.sin(f*.73+t*1.31),r=t%4==0?2.8+m*1.6:0,i=t%5==0?-.85:0,o=(f+t)%5==0;a.push({id:f*10+t,type:o?`refill`:`instant`,amount:o?100:25,refillRate:25,position:{x:g+Math.sin(f*1.11+t*1.7)*(5.2+m*3.4),y:Math.max(1.25,2+n*(1.9+m)+r+i),z:h+Wu*e},radius:1.15})});let v=3+Math.floor(m*5);for(let e=0;e<v;e+=1){let t=f*13.37+e*5.19,n=Math.sin(t)*(7+m*7),r=h+38+Wu/v*e-Wu,i=2.4+m*6+(f+e)%3;o.push({type:`spire`,position:{x:n,y:i/2-.05,z:r},size:{x:1.8+m*1.1,y:i,z:1.8+m*1.1}})}if(f>1&&[-1,1].forEach((e,t)=>{let n=5.5+m*9+(f+t)%4;o.push({type:`mountain`,position:{x:e*(11.5+Math.sin(f*.71+t)*3.2),y:n/2-.2,z:h-58-t*34},size:{x:4.8+m*3.4,y:n,z:4.8+m*3.4}})}),f>1&&f%2==0){let e=h+72,t=4.2+m*4.8+f%2*2.2,n=Math.max(3.4,5.6-m*1.6);s.push({type:`wall`,position:{x:Math.sin(f*.91)*4-10.5,y:t,z:e},size:{x:4.8+m*2.5,y:9+m*5,z:.9}}),s.push({type:`wall`,position:{x:Math.sin(f*.91)*4+10.5,y:t,z:e},size:{x:4.8+m*2.5,y:9+m*5,z:.9}}),c.push({type:`roof`,position:{x:Math.sin(f*.91)*4,y:t+n*.5+4.2,z:e},size:{x:17+m*6,y:.9,z:1.2}}),c.push({type:`roof`,position:{x:Math.sin(f*.91)*4,y:Math.max(1,t-n*.5-2.4),z:e},size:{x:14+m*4,y:.55,z:1.2}})}if(f>2&&f%4==0&&c.push({type:`roof`,position:{x:Math.cos(f*.71)*5,y:7.4-m*1.6,z:h+24},size:{x:13+m*9,y:.75,z:11}}),f>2&&f%4==1&&d.push(Y(Gu,this,Zu).call(this,{obstacles:o,roofs:c,routeX:_.position.x+(g-_.position.x)*.35,z:h-74,difficulty:m,caveIndex:f})),f>1&&f%3==0){let e=h-44,t=Math.sin(f*.63)*4.5,n=6.2+m*6.8,r=Math.max(7.2,11.5-m*2.4),i=Math.max(5.2,8.5-m*1.6),o=32+m*18,s=1.05;l.push({type:`tunnel`,segment:`left`,position:{x:t-r/2-s/2,y:n,z:e},size:{x:s,y:i+s*2,z:o}},{type:`tunnel`,segment:`right`,position:{x:t+r/2+s/2,y:n,z:e},size:{x:s,y:i+s*2,z:o}},{type:`tunnel`,segment:`top`,position:{x:t,y:n+i/2+s/2,z:e},size:{x:r+s*2,y:s,z:o}},{type:`tunnel`,segment:`bottom`,position:{x:t,y:Math.max(.7,n-i/2-s/2),z:e},size:{x:r+s*2,y:s,z:o}}),a.push({id:f*10+9,type:`instant`,amount:25,position:{x:t,y:n,z:e},radius:1.35})}if(f>3){let e=1+Math.floor(Math.min(2,m));for(let t=0;t<e;t+=1){let e=7+m*2.5,n=h-26-t*52;u.push({type:t%2==0?`movingWall`:`movingSpire`,motion:t%2==0?`slideX`:`bobY`,phase:f*.9+t*1.7,speed:.75+m*.38,amplitude:t%2==0?e:2.2+m*.9,position:{x:Math.sin(f*.67+t)*3,y:t%2==0?3.2+m*1.4:4.2+m*1.8,z:n},size:t%2==0?{x:2.1+m*.8,y:5.4+m*1.6,z:1}:{x:2.2+m*.6,y:4.4+m*1.7,z:2.2+m*.6}})}}}return o=o.filter(e=>!Y(Gu,this,Qu).call(this,e,d)),{id:1,name:`Endless Route`,description:`One route that keeps escalating with each save marker.`,gravity:-3.9,thrustPower:7.35,steeringPower:3.65,damping:.992,fuelBurnRate:6.67,windStrength:0,windDirection:{x:0,y:0,z:0},maxSpeed:{horizontal:7.6,verticalUp:7.6,verticalDown:8.8},launchPad:{id:t||`launch`,position:{x:r,y:.1,z:n},size:{x:6,y:.2,z:6}},landingPad:i[0],checkpoints:i,pickups:a,landingThresholds:{verticalSpeed:2.35,horizontalSpeed:2.15,angle:.48},worldBounds:{minX:-26,maxX:26,minZ:n-Uu-220,maxZ:n+28,maxY:32},terrain:{width:62,depth:5780,segments:128,amplitude:.72,frequency:.085,seed:11+Math.floor(e/Wu),centerZ:n-Uu/2,startDistance:e},obstacles:o,roofs:c,walls:s,tunnels:l,movers:u,tutorialMessages:[`Reach save markers`,`Collect Drop fuel`,`Harder route ahead`],scoreMultiplier:1,visualTheme:{terrain:2107443},startDistance:e}}function Ju(e){return Math.min(2.6,.35+e/900)}function Yu(e){let t=e*Wu;return Math.sin(e*1.73)*Math.min(11,3+Y(Gu,this,Ju).call(this,t)*9)}function Xu({walls:e,roofs:t,routeX:n,z:r,difficulty:i,firstGate:a,gateIndex:o}){let s=31.5,c=1.25+i*.18,l=Math.max(a?8.6:5.6,12.2-i*2.65),u=Math.max(a?6.2:4.3,7.1-i*.9),d=o%6,f=a||d===1?.9:d===2?2.4:d===3?4.2:d===4?6.1:d===5?3.1:1.5,p=a?0:Math.max(0,Math.sin(o*1.37))*(.7+i*.45),m=Math.min(s-u-2.5,f+p),h=m+u,g=n-l/2,_=n+l/2,v=Math.max(.1,g- -26),y=Math.max(.1,26-_);return e.push({type:`wall`,position:{x:-26+v/2,y:s/2,z:r},size:{x:v,y:s,z:c}},{type:`wall`,position:{x:_+y/2,y:s/2,z:r},size:{x:y,y:s,z:c}}),t.push({type:`roof`,position:{x:n,y:h+(s-h)/2,z:r},size:{x:l+1.4,y:s-h,z:c}}),m>.75&&t.push({type:`roof`,position:{x:n,y:m/2,z:r},size:{x:l+1.4,y:m,z:c}}),{routeX:n,z:r,width:l,bottom:m,top:h,depth:68}}function Zu({obstacles:e,roofs:t,routeX:n,z:r,difficulty:i,caveIndex:a}){let o=Math.min(24,14.2+i*2.2),s=Math.min(38,24+i*5.5),c=54+i*12;t.push({type:`caveRoof`,position:{x:n,y:o,z:r},size:{x:s,y:1.1,z:c}});let l=4+Math.floor(Math.min(4,i*1.4));for(let t=0;t<l;t+=1){let s=t%2==0?-1:1,u=3.8+t%3*2.2+i*.8,d=Math.min(10.5,4.4+i*2.2+(a+t)%3*1.2);e.push({type:`caveSpike`,position:{x:n+s*u+Math.sin(a*.8+t)*1.2,y:o-d/2,z:r-c*.35+(t+.5)*(c/l)},size:{x:2.4+i*.7,y:d,z:2.4+i*.7}})}return{routeX:n,z:r,width:Math.max(7.4,10.5-i),bottom:2.2,top:o-2.2,depth:c+18}}function Qu(e,t){return t.some(t=>{let n=e.size.x/2,r=e.size.z/2,i=t.width/2+2.8,a=t.depth/2,o=Math.abs(e.position.x-t.routeX)<n+i,s=Math.abs(e.position.z-t.z)<r+a,c=e.position.y-e.size.y/2,l=e.position.y+e.size.y/2>t.bottom-1.2&&c<t.top+1.2;return o&&s&&l})}var $u=new WeakSet,ed=class{constructor(){cu(this,$u)}loadSettings(){return{...Xl,...Y($u,this,td).call(this,zl.settings,{})}}saveSettings(e){localStorage.setItem(zl.settings,JSON.stringify(e))}loadProgress(){return{totalScore:0,bestTotalScore:0,highestUnlockedLevel:1,bestScores:{},bestGrades:{},attempts:{},perfectLandings:0,leaderboard:{bestDistance:0,bestDistanceTime:0,runs:[]},...Y($u,this,td).call(this,zl.progress,{})}}saveProgress(e){localStorage.setItem(zl.progress,JSON.stringify(e))}loadProfile(){return{purchases:{},...Y($u,this,td).call(this,zl.profile,{})}}};function td(e,t){try{return JSON.parse(localStorage.getItem(e))??t}catch{return t}}var nd=new WeakSet,rd=class{constructor(e){cu(this,nd),this.saveSystem=e,this.profile=Y(nd,this,id).call(this)}refresh(){return this.profile=Y(nd,this,id).call(this),this.profile}hasPurchase(e=Bl){return!!(this.profile.purchases?.[e]||this.profile.entitlements?.[e])}isLoggedIn(){return!!(this.profile.id&&this.profile.id!==`guest`)}};function id(){let e=window.BSG_PROFILE??window.launch3001Profile??null,t=window.__launch3001Profile??null,n=Y(nd,this,ad).call(this),r=this.saveSystem.loadProfile(),i={id:`guest`,name:`Guest Pilot`,email:``,avatar:``,purchases:{},entitlements:{},source:`guest`,...r,...n,...t,...e};return i.purchases=Y(nd,this,od).call(this,r.purchases,n?.purchases,t?.purchases,e?.purchases),i.entitlements=Y(nd,this,od).call(this,r.entitlements,n?.entitlements,t?.entitlements,e?.entitlements),new URLSearchParams(window.location.search).get(`full`)===`1`&&(i.purchases[Bl]=!0,i.source=`url-dev`),i}function ad(){for(let e of[`bsg.profile`,`BSG_PROFILE`,`bsgProfile`])try{let t=localStorage.getItem(e);if(t)return{source:`bsg-storage`,...JSON.parse(t)}}catch{}return null}function od(...e){let t={};for(let n of e)Array.isArray(n)?n.forEach(e=>{e&&(t[e]=!0)}):n&&typeof n==`object`&&Object.assign(t,n);return t}var sd={[Jl.perfect]:700,[Jl.excellent]:520,[Jl.good]:360,[Jl.safe]:220,[Jl.hard]:100},cd=new WeakSet,ld=class{constructor(e){cu(this,cd),this.saveSystem=e,this.progress=e.loadProgress(),this.currentLevelScore=0}recordAttempt(e){this.progress.attempts[e]=(this.progress.attempts[e]??0)+1,this.saveSystem.saveProgress(this.progress)}scoreLanding(e,t,n,r){let i=e.landingThresholds,a=Math.max(0,1-Math.abs(t.velocity.y)/i.verticalSpeed)*180,o=Math.hypot(t.velocity.x,t.velocity.z),s=Math.max(0,1-o/i.horizontalSpeed)*180,c=Math.max(0,1-t.getTiltAngle()/i.angle)*160,l=Math.max(0,120-t.flightTime*4),u=Math.max(0,120-t.thrustUse*18),d=r?0:120,f=500+sd[n]+a+s+c+l+u+d;return this.currentLevelScore=Math.round(f*e.scoreMultiplier),this.currentLevelScore}commitLevel(e,t,n){let r=this.currentLevelScore;this.progress.totalScore+=r,this.progress.bestTotalScore=Math.max(this.progress.bestTotalScore,this.progress.totalScore),this.progress.bestScores[e]=Math.max(this.progress.bestScores[e]??0,r),this.progress.bestGrades[e]=Y(cd,this,ud).call(this,this.progress.bestGrades[e],t),t===Jl.perfect&&(this.progress.perfectLandings+=1),n&&(this.progress.highestUnlockedLevel=Math.max(this.progress.highestUnlockedLevel,n)),this.saveSystem.saveProgress(this.progress)}resetRun(){this.progress.totalScore=0,this.currentLevelScore=0,this.saveSystem.saveProgress(this.progress)}updateLeaderboard(e,t){let n=this.progress.leaderboard??{bestDistance:0,bestDistanceTime:0,runs:[]},r=Math.floor(e),i=Number(t.toFixed(1)),a=r>(n.bestDistance??0),o=r===n.bestDistance&&(!n.bestDistanceTime||i<n.bestDistanceTime);!a&&!o||(this.progress.leaderboard={...n,bestDistance:r,bestDistanceTime:i},this.saveSystem.saveProgress(this.progress))}recordRun(e,t){let n=this.progress.leaderboard??{bestDistance:0,bestDistanceTime:0,runs:[]},r={id:Date.now(),distance:Math.max(0,Math.floor(e)),time:Number(Math.max(0,t).toFixed(1)),score:this.progress.totalScore},i=[...n.runs??[],r].sort((e,t)=>t.distance-e.distance||e.time-t.time),a=i.findIndex(e=>e.id===r.id)+1,o=i.slice(0,25),s=Math.max(n.bestDistance??0,r.distance),c=r.distance>(n.bestDistance??0)||r.distance===(n.bestDistance??0)&&(!n.bestDistanceTime||r.time<n.bestDistanceTime)?r.time:n.bestDistanceTime;return this.progress.leaderboard={...n,runs:o,bestDistance:s,bestDistanceTime:c},this.saveSystem.saveProgress(this.progress),{...r,placement:a,trophy:a===1?`gold`:a===2?`silver`:a===3?`bronze`:null}}scoreCheckpoint(e,t,n){let r=t<=30?Math.min(200,30/Math.max(15,t)*100):Math.max(25,100-(t-30)/60*50),i=Math.floor(n/100)*5;return this.currentLevelScore=Math.round(r+i),this.currentLevelScore}checkpointBreakdown(e,t,n){let r=t<=15?`DOUBLE TIME`:t<=30?`FULL BONUS`:t<=60?`LATE SAVE`:`SURVIVAL SAVE`;return{markerId:e.id,elapsed:Number(t.toFixed(1)),distance:Math.floor(n),timeRank:r,points:this.currentLevelScore}}commitCheckpoint(e,t,n){this.progress.totalScore+=t,this.progress.bestTotalScore=Math.max(this.progress.bestTotalScore,this.progress.totalScore),this.progress.bestScores[e.id]=Math.max(this.progress.bestScores[e.id]??0,t),this.progress.bestGrades[e.id]=`SAVED`,n&&(this.progress.highestUnlockedLevel=Math.max(this.progress.highestUnlockedLevel,n)),this.saveSystem.saveProgress(this.progress)}};function ud(e,t){let n=[Jl.hard,Jl.safe,Jl.good,Jl.excellent,Jl.perfect];return n.indexOf(t)>n.indexOf(e)?t:e??t}var dd=new WeakSet,fd=class{constructor(e){cu(this,dd),this.settings=e,this.context=null,this.engine=null,this.lastSpeech=new Map,this.speechUnlocked=!1,document.addEventListener(`visibilitychange`,()=>{document.hidden&&this.stopEngine()})}async unlock(){if(Y(dd,this,hd).call(this),this.settings.muted)return;let e=window.AudioContext||window.webkitAudioContext;if(e)try{this.context||(this.context=new e),this.context.state!==`running`&&await this.context.resume()}catch{this.context=null}}async enable(){this.settings.muted=!1,this.settings.volume=Math.max(this.settings.volume??.55,.7),await this.unlock(),this.playClick(),this.speak(`Audio online.`,`audioOnline`,1e3)}playClick(){Y(dd,this,md).call(this,440,.04,.025)}playCrash(){Y(dd,this,md).call(this,82,.32,.2,`sawtooth`),window.setTimeout(()=>Y(dd,this,md).call(this,48,.42,.16,`triangle`),90)}playLanding(e=!1){Y(dd,this,md).call(this,e?740:520,.12,.08),window.setTimeout(()=>Y(dd,this,md).call(this,e?980:660,.16,e?.11:.08),90)}playCheckpoint(){Y(dd,this,md).call(this,660,.08,.07),window.setTimeout(()=>Y(dd,this,md).call(this,880,.1,.08),80),window.setTimeout(()=>Y(dd,this,md).call(this,1180,.16,.07),170)}speak(e,t=e,n=2500){if(this.settings.muted||!(`speechSynthesis`in window))return;this.speechUnlocked||Y(dd,this,hd).call(this);let r=performance.now();if(r-(this.lastSpeech.get(t)??-1/0)<n)return;this.lastSpeech.set(t,r),window.speechSynthesis.cancel();let i=new SpeechSynthesisUtterance(e);i.rate=1.02,i.pitch=.88,i.volume=Math.min(1,Math.max(.15,this.settings.volume??.55)),window.speechSynthesis.speak(i)}startEngine(){if(!this.context||this.settings.muted||this.engine)return;let e=this.context.currentTime,t=this.context.createGain();t.gain.setValueAtTime(0,e),t.gain.linearRampToValueAtTime((this.settings.volume??.55)*.12,e+.16);let n=this.context.createOscillator();n.type=`sine`,n.frequency.setValueAtTime(54,e);let r=this.context.createGain();r.gain.value=.42;let i=this.context.createOscillator();i.type=`triangle`,i.frequency.setValueAtTime(86,e);let a=this.context.createGain();a.gain.value=.14;let o=this.context.createBufferSource();o.buffer=Y(dd,this,pd).call(this),o.loop=!0;let s=this.context.createBiquadFilter();s.type=`lowpass`,s.frequency.value=420,s.Q.value=.7;let c=this.context.createGain();c.gain.value=.16,n.connect(r).connect(t),i.connect(a).connect(t),o.connect(s).connect(c).connect(t),t.connect(this.context.destination),n.start(e),i.start(e),o.start(e),this.engine={low:n,rumble:i,noise:o,master:t}}stopEngine(){if(!this.engine)return;let e=this.context.currentTime;this.engine.master.gain.setTargetAtTime(0,e,.08),this.engine.low.stop(e+.22),this.engine.rumble.stop(e+.22),this.engine.noise.stop(e+.22),this.engine=null}};function pd(){if(this.noiseBuffer)return this.noiseBuffer;let e=Math.floor((this.context?.sampleRate??44100)*1.4),t=this.context.createBuffer(1,e,this.context.sampleRate),n=t.getChannelData(0),r=0;for(let t=0;t<e;t+=1)r=r*.86+(Math.random()*2-1)*.14,n[t]=r;return this.noiseBuffer=t,t}function md(e,t,n,r=`triangle`){if(!this.context||this.settings.muted)return;let i=this.context.createOscillator(),a=this.context.createGain();i.frequency.value=e,i.type=r,a.gain.value=this.settings.volume*n,i.connect(a).connect(this.context.destination),i.start(),a.gain.setTargetAtTime(0,this.context.currentTime+t*.55,.04),i.stop(this.context.currentTime+t)}function hd(){if(this.speechUnlocked||!(`speechSynthesis`in window)||!(`SpeechSynthesisUtterance`in window)||navigator.userActivation&&!navigator.userActivation.isActive)return;window.speechSynthesis.resume();let e=new SpeechSynthesisUtterance(` `);e.volume=0,e.rate=1,window.speechSynthesis.speak(e),this.speechUnlocked=!0}var gd=class{constructor(e){this.scene=e,this.pool=[],this.active=[],this.trailPool=[],this.trails=[],this.exhaustTimer=0,this.flash=new Ja(16726815,0,8),e.add(this.flash);let t=new Yr({color:16747042,transparent:!0,opacity:.8});for(let n=0;n<64;n+=1){let n=new K(new ea(.06,6,6),t.clone());n.visible=!1,n.userData.velocity=new V,e.add(n),this.pool.push(n)}let n=new Yr({color:16751150,transparent:!0,opacity:.42,blending:2,depthWrite:!1});for(let t=0;t<36;t+=1){let t=new K(new ea(.13,8,8),n.clone());t.visible=!1,t.userData.velocity=new V,e.add(t),this.trailPool.push(t)}}burst(e,t=16738848,n=18){this.flash.position.copy(e),this.flash.intensity=3;for(let r=0;r<n&&this.pool.length;r+=1){let n=this.pool.pop();n.visible=!0,n.position.copy(e),n.material.color.setHex(t),n.material.opacity=.72,n.userData.life=.55+Math.random()*.3,n.scale.setScalar(.36+Math.random()*.92),n.userData.velocity.set((Math.random()-.5)*4.4,Math.random()*3.4,(Math.random()-.5)*4.4),this.active.push(n)}}emitLandingDust(e){this.burst(e,14216946,9)}emitExhaust(e,t){if(this.exhaustTimer-=t,!e.thrusting||this.exhaustTimer>0||!this.trailPool.length)return;this.exhaustTimer=.035;let n=this.trailPool.pop();n.visible=!0,n.position.copy(e.position),n.position.y-=1.35,n.material.opacity=.38,n.scale.setScalar(.35+Math.random()*.25),n.userData.life=.42,n.userData.velocity.set((Math.random()-.5)*.55-e.velocity.x*.08,-1.2-Math.random()*.5,(Math.random()-.5)*.55-e.velocity.z*.08),this.trails.push(n)}update(e,t=null){t&&this.emitExhaust(t,e),this.flash.intensity=Math.max(0,this.flash.intensity-e*8);for(let t=this.active.length-1;t>=0;--t){let n=this.active[t];n.userData.life-=e,n.userData.velocity.y-=5*e,n.position.addScaledVector(n.userData.velocity,e),n.material.opacity=Math.max(0,n.userData.life),n.userData.life<=0&&(n.visible=!1,this.active.splice(t,1),this.pool.push(n))}for(let t=this.trails.length-1;t>=0;--t){let n=this.trails[t];n.userData.life-=e,n.position.addScaledVector(n.userData.velocity,e),n.scale.multiplyScalar(1+e*1.8),n.material.opacity=Math.max(0,n.userData.life*.9),n.userData.life<=0&&(n.visible=!1,this.trails.splice(t,1),this.trailPool.push(n))}}},_d=`0.1.0-c07a9ab`,X=new WeakSet,vd=class{constructor(e,t,n){cu(this,X),this.renderer=e.renderer,this.scene=t,this.camera=n,this.enabled=!1,this.sessionStarted=!1,this.thrust=!1,this.steering={x:0,z:0},this.status=`VR READY`,this.settingsOpen=!1,this.selectedSetting=0,this.menuConfirm=!1,this.settingsButtonDown=!1,this.audioButtonDown=!1,this.stickCooldown=0,this.rig=new _n,this.rig.name=`VR cockpit rig`,this.rig.add(n),t.add(this.rig),this.rightController=null,this.rightNeutral=new bt,this.rightRelative=new bt,this.rightEuler=new Qt(0,0,0,`YXZ`),this.raycaster=new go,this.rayOrigin=new V,this.rayDirection=new V,this.tempMatrix=new Ht,this.cameraWorldPosition=new V,this.cameraWorldQuaternion=new bt,this.panelOffset=new V(0,-.22,-1.85),this.hudOffset=new V(0,-.72,-1.74),this.topStatsOffset=new V(0,.62,-1.7),this.cockpitOffset=new V(0,.82,1.05),this.rigRotation=0,this.controllers=[0,1].map(e=>Y(X,this,yd).call(this,e)),this.panel=Y(X,this,jd).call(this),this.topStatsPanel=Y(X,this,Md).call(this,768,88,1.95,.22),t.add(this.panel.group),t.add(this.topStatsPanel.group),this.renderer.xr.addEventListener(`sessionstart`,()=>{this.enabled=!0,this.sessionStarted=!0,this.status=`VR ACTIVE`,this.panel.group.visible=!0,this.topStatsPanel.group.visible=!0,Y(X,this,Ad).call(this)}),this.renderer.xr.addEventListener(`sessionend`,()=>{this.enabled=!1,this.thrust=!1,this.steering.x=0,this.steering.z=0,this.status=`VR READY`,this.panel.group.visible=!1,this.topStatsPanel.group.visible=!1,this.rig.position.set(0,0,0),this.rig.rotation.set(0,0,0)})}update(e,t){this.enabled&&(this.stickCooldown=Math.max(0,this.stickCooldown-t),Y(X,this,Nd).call(this,e),Y(X,this,xd).call(this),Y(X,this,bd).call(this,e),Y(X,this,Sd).call(this,e),Y(X,this,Pd).call(this,e,t),e.cameraController.mode!==Gl.cockpit&&e.cameraController.setMode(Gl.cockpit))}getInput(){return{thrust:this.enabled&&!this.settingsOpen&&this.thrust,steering:this.enabled&&!this.settingsOpen?this.steering:{x:0,z:0}}}consumeSessionStart(){return this.sessionStarted?(this.sessionStarted=!1,!0):!1}calibrate(){Y(X,this,Ad).call(this)}};function yd(e){let t=this.renderer.xr.getController(e);e===1&&(this.rightController=t),t.addEventListener(`selectstart`,()=>{if(e===1){if(this.settingsOpen){this.menuConfirm=!0;return}this.thrust=!0}}),t.addEventListener(`selectend`,()=>{e===1&&(this.thrust=!1)});let n=new Ei(new yr().setFromPoints([new V(0,0,0),new V(0,0,-2.2)]),new vi({color:2416639,transparent:!0,opacity:.72}));return n.name=`VR menu pointer`,n.visible=!1,t.add(n),t.userData.pointer=n,this.scene.add(t),t}function bd(e){let t=!1;for(let e of this.renderer.xr.getSession()?.inputSources??[]){let n=e.gamepad?.buttons;n&&(t||(t=!!(n[3]?.pressed||n[5]?.pressed)))}t&&!this.settingsButtonDown&&(this.settingsOpen=!this.settingsOpen,this.thrust=!1,this.status=this.settingsOpen?`VR MENU`:`VR ACTIVE`,this.panel.group.visible=!0),this.settingsButtonDown=t}function xd(){let e=0,t=0;this.rightController&&(this.rightRelative.copy(this.rightNeutral).invert().multiply(this.rightController.quaternion),this.rightEuler.setFromQuaternion(this.rightRelative),e+=tu(-this.rightEuler.z/.55,-1,1),t+=tu(this.rightEuler.x/.55,-1,1));for(let n of this.renderer.xr.getSession()?.inputSources??[]){if(n.handedness&&n.handedness!==`right`)continue;let r=n.gamepad?.axes;if(!r||r.length<2)continue;let i=r.length>=4?r[2]:r[0],a=r.length>=4?r[3]:r[1];e+=Math.abs(i)>.12?i:0,t+=Math.abs(a)>.12?a:0}this.steering.x=tu(e,-1,1),this.steering.z=tu(t,-1,1)}function Sd(e){if(!this.settingsOpen){this.menuConfirm=!1,Y(X,this,Cd).call(this,!1);return}Y(X,this,Cd).call(this,!0),Y(X,this,wd).call(this,e);let t=Y(X,this,Td).call(this);this.stickCooldown<=0&&(t.y<-.55?(this.selectedSetting=(this.selectedSetting+Y(X,this,Ed).call(this,e).length-1)%Y(X,this,Ed).call(this,e).length,this.stickCooldown=.22):t.y>.55?(this.selectedSetting=(this.selectedSetting+1)%Y(X,this,Ed).call(this,e).length,this.stickCooldown=.22):t.x<-.55?(Y(X,this,Dd).call(this,e,-1),this.stickCooldown=.18):t.x>.55&&(Y(X,this,Dd).call(this,e,1),this.stickCooldown=.18)),this.menuConfirm&&(Y(X,this,wd).call(this,e),Y(X,this,Od).call(this,e),this.menuConfirm=!1)}function Cd(e){this.controllers.forEach(t=>{t.userData.pointer&&(t.userData.pointer.visible=e)})}function wd(e){let t=this.rightController;if(!t||!this.panel.mesh)return!1;this.tempMatrix.identity().extractRotation(t.matrixWorld),this.rayOrigin.setFromMatrixPosition(t.matrixWorld),this.rayDirection.set(0,0,-1).applyMatrix4(this.tempMatrix).normalize(),this.raycaster.set(this.rayOrigin,this.rayDirection);let n=this.raycaster.intersectObject(this.panel.mesh,!1)[0];if(!n?.uv)return!1;let r=(1-n.uv.y)*this.panel.canvas.height,i=Y(X,this,Ed).call(this,e),a=Math.floor((r-86)/22);return a>=0&&a<i.length?(this.selectedSetting=a,!0):!1}function Td(){for(let e of this.renderer.xr.getSession()?.inputSources??[]){if(e.handedness&&e.handedness!==`right`)continue;let t=e.gamepad?.axes;if(!(!t||t.length<2))return{x:t.length>=4?t[2]:t[0],y:t.length>=4?t[3]:t[1]}}return{x:0,y:0}}function Ed(e){return[{key:`lobby`,label:`LOBBY`,value:`SELECT`},{key:`resetRun`,label:`RESET`,value:`SELECT`}]}function Dd(e,t){this.selectedSetting=tu(this.selectedSetting+t,0,Y(X,this,Ed).call(this,e).length-1)}function Od(e){let t=Y(X,this,Ed).call(this,e)[this.selectedSetting];t.key===`resetRun`?(Y(X,this,kd).call(this),e.resetRun()):t.key===`lobby`&&(Y(X,this,kd).call(this),e.showLobby())}function kd(){this.settingsOpen=!1,this.panel.group.visible=!0,this.status=`VR ACTIVE`,Y(X,this,Cd).call(this,!1)}function Ad(){this.rightController&&this.rightNeutral.copy(this.rightController.quaternion)}function jd(){return Y(X,this,Md).call(this,768,384,2.05,1.02)}function Md(e,t,n,r){let i=document.createElement(`canvas`);i.width=e,i.height=t;let a=i.getContext(`2d`),o=new zi(i);o.colorSpace=Ye;let s=new Yr({map:o,transparent:!0,depthTest:!1}),c=new K(new Qi(n,r),s),l=new _n;return l.visible=!1,l.add(c),{group:l,mesh:c,canvas:i,context:a,texture:o}}function Nd(e){let t=e.settings,n=t.vrCameraMode??ql.cockpit,r=t.vrCameraDistance??2.3,i=t.vrCameraHeight??.85,a=t.vrComfortScale??1,o=t.vrSideCameraSide??1;n===ql.chase?(this.cockpitOffset.set(0,i+1.1*a,r),this.rigRotation=0):n===ql.side?(this.cockpitOffset.set(o*r,i+.45*a,.8),this.rigRotation=o>0?-Math.PI/2:Math.PI/2):(this.cockpitOffset.set(0,i,1.05*a),this.rigRotation=0),this.panelOffset.set(0,t.vrPanelHeight??-.22,-(t.vrPanelDistance??1.85)),this.rig.position.copy(e.rocket.position).add(this.cockpitOffset),this.rig.rotation.set(0,this.rigRotation,0),this.camera.near=.03,this.camera.far=140}function Pd(e){if(this.panel.group.visible=this.enabled,this.topStatsPanel.group.visible=this.enabled&&!this.settingsOpen,!this.panel.group.visible)return;let{context:t,canvas:n,texture:r,group:i}=this.panel;t.clearRect(0,0,n.width,n.height),this.settingsOpen?(t.fillStyle=`rgba(3, 9, 16, 0.82)`,t.fillRect(0,0,n.width,n.height),t.strokeStyle=`#27d8ff`,t.lineWidth=4,t.strokeRect(8,8,n.width-16,n.height-16),Y(X,this,Ud).call(this,t,e)):Y(X,this,Ld).call(this,t,e),r.needsUpdate=!0,Y(X,this,Id).call(this,i,this.settingsOpen?this.panelOffset:this.hudOffset),Y(X,this,Fd).call(this,e)}function Fd(e){if(!this.topStatsPanel.group.visible)return;let{context:t,canvas:n,texture:r,group:i}=this.topStatsPanel;t.clearRect(0,0,n.width,n.height),Y(X,this,Rd).call(this,t,e),r.needsUpdate=!0,Y(X,this,Id).call(this,i,this.topStatsOffset)}function Id(e,t){this.camera.getWorldPosition(this.cameraWorldPosition),this.camera.getWorldQuaternion(this.cameraWorldQuaternion),e.position.copy(t).applyQuaternion(this.cameraWorldQuaternion).add(this.cameraWorldPosition),e.quaternion.copy(this.cameraWorldQuaternion)}function Ld(e,t){let n=Math.max(0,Math.min(1,t.rocket.fuel/100)),r=Math.max(0,t.rocket.position.y-t.world.getTerrainHeight(t.rocket.position.x,t.rocket.position.z)-t.rocket.radius),i=(t.currentLevel.checkpoints??[]).find(e=>!t.passedMarkers.has(e.id));i&&Math.max(0,i.distance-t.rocket.distance);let a=Math.max(0,t.rocket.flightTime-t.lastCheckpointTime),o=(-135+Math.max(0,Math.min(1,r/24))*270)*Math.PI/180;e.textBaseline=`alphabetic`,Y(X,this,Hd).call(this,e,142,222,484,142,8),e.fillStyle=`rgba(3, 10, 18, 0.58)`,e.fill(),e.strokeStyle=`rgba(49, 213, 255, 0.28)`,e.lineWidth=2,e.stroke(),e.fillStyle=`rgba(4, 12, 22, 0.78)`,Y(X,this,Hd).call(this,e,626,272,28,48,8),e.fill(),e.strokeStyle=`rgba(82, 220, 255, 0.34)`,e.stroke(),e.fillStyle=`#d8fbff`,e.font=`900 24px system-ui`,e.fillText(`>`,635,304),e.fillStyle=`#7fa6ba`,e.font=`800 13px system-ui`,e.fillText(`FUEL`,160,252),e.fillStyle=`rgba(5, 15, 24, 0.86)`,Y(X,this,Hd).call(this,e,212,237,322,20,4),e.fill();let s=e.createLinearGradient(212,0,534,0);s.addColorStop(0,`#21ffd4`),s.addColorStop(.62,`#ffd166`),s.addColorStop(1,`#ff5f4a`),e.fillStyle=s,Y(X,this,Hd).call(this,e,212,237,322*n,20,4),e.fill(),e.strokeStyle=`rgba(125, 238, 255, 0.38)`,e.strokeRect(212,237,322,20),e.fillStyle=`#f4fbff`,e.font=`800 15px system-ui`,e.fillText(`${t.rocket.fuel.toFixed(0)}%`,548,253),Y(X,this,zd).call(this,e,160,280,64,38,`MENU`,!1),Y(X,this,Vd).call(this,e,306,298,29,o,r),Y(X,this,Bd).call(this,e,518,299,31,t.rocket.thrusting),e.font=`800 12px system-ui`,e.fillStyle=`#7fa6ba`,e.fillText(`V/S ${t.rocket.velocity.y.toFixed(1)}`,160,342),e.fillText(`H/S ${Math.hypot(t.rocket.velocity.x,t.rocket.velocity.z).toFixed(1)}`,244,342),e.fillText(`ANGLE ${(t.rocket.getTiltAngle()*57.3).toFixed(0)}deg`,335,342),e.fillText(`TIME ${a.toFixed(1)}s`,448,342),e.fillText(`BUILD ${_d}`,548,342)}function Rd(e,t){let n=(t.currentLevel.checkpoints??[]).find(e=>!t.passedMarkers.has(e.id)),r=n?Math.max(0,n.distance-t.rocket.distance):0,i=Math.max(0,t.rocket.flightTime-t.lastCheckpointTime),a=t.score.progress.leaderboard?.bestDistance??0,o=t.score.progress.leaderboard?.bestDistanceTime??0;Y(X,this,Hd).call(this,e,20,14,728,52,8),e.fillStyle=`rgba(3, 10, 18, 0.62)`,e.fill(),e.strokeStyle=`rgba(49, 213, 255, 0.22)`,e.lineWidth=2,e.stroke(),e.font=`800 15px system-ui`,e.fillStyle=`#7fa6ba`,e.fillText(`SCORE ${t.score.progress.totalScore}`,44,47),e.fillText(`BEST ${t.score.progress.bestTotalScore}`,150,47),e.fillText(`BEST DIST ${a.toFixed(0)}m/${o.toFixed(1)}s`,258,47),e.fillText(`DIST ${t.rocket.distance.toFixed(0)}m`,456,47),e.fillText(`MARKER ${r.toFixed(0)}m`,574,47),e.fillText(`TIME ${i.toFixed(1)}s`,682,47)}function zd(e,t,n,r,i,a){Y(X,this,Hd).call(this,e,t,n,r,i,8),e.fillStyle=`rgba(4, 12, 22, 0.74)`,e.fill(),e.strokeStyle=`rgba(82, 220, 255, 0.3)`,e.lineWidth=2,e.stroke(),e.fillStyle=`#ecfbff`,e.font=`800 11px system-ui`,e.textAlign=`center`,e.fillText(a,t+r/2,n+24),e.textAlign=`left`}function Bd(e,t,n,r,i){let a=i?.92:.42;e.shadowColor=`rgba(255, 45, 32, 0.9)`,e.shadowBlur=i?30:16;let o=e.createRadialGradient(t-8,n-10,4,t,n,r);o.addColorStop(0,i?`#ffe1d8`:`#ffb2a4`),o.addColorStop(.45,i?`#ff4b36`:`#ff2d20`),o.addColorStop(1,i?`#b81410`:`#81110d`),e.fillStyle=o,e.beginPath(),e.arc(t,n,r,0,Math.PI*2),e.fill(),e.shadowBlur=0,e.strokeStyle=`rgba(255, 120, 100, ${a})`,e.lineWidth=3,e.stroke(),e.fillStyle=`#fff7f4`,e.font=`900 11px system-ui`,e.textAlign=`center`,e.fillText(`BOOST`,t,n+4),e.textAlign=`left`}function Vd(e,t,n,r,i,a){let o=e.createConicGradient(Math.PI*1.25,t,n);o.addColorStop(0,`#ff5f4a`),o.addColorStop(.18,`#ffd166`),o.addColorStop(.56,`#21ffd4`),o.addColorStop(.75,`rgba(0, 0, 0, 0)`),o.addColorStop(1,`rgba(0, 0, 0, 0)`),e.fillStyle=o,e.beginPath(),e.arc(t,n,r,0,Math.PI*2),e.fill(),e.fillStyle=`rgba(4, 12, 22, 0.92)`,e.beginPath(),e.arc(t,n,r-7,0,Math.PI*2),e.fill(),e.strokeStyle=`rgba(125, 238, 255, 0.42)`,e.lineWidth=2,e.beginPath(),e.arc(t,n,r,0,Math.PI*2),e.stroke(),e.strokeStyle=`#f4fbff`,e.lineWidth=3,e.beginPath(),e.moveTo(t,n),e.lineTo(t+Math.sin(i)*22,n-Math.cos(i)*22),e.stroke(),e.fillStyle=`#21ffd4`,e.beginPath(),e.arc(t,n,5,0,Math.PI*2),e.fill(),e.fillStyle=`#f4fbff`,e.font=`800 12px system-ui`,e.textAlign=`center`,e.fillText(a.toFixed(1),t,n+50),e.fillStyle=`#7fa6ba`,e.font=`800 10px system-ui`,e.fillText(`ALT`,t,n+64),e.textAlign=`left`}function Hd(e,t,n,r,i,a){let o=Math.min(a,r/2,i/2);e.beginPath(),e.moveTo(t+o,n),e.lineTo(t+r-o,n),e.quadraticCurveTo(t+r,n,t+r,n+o),e.lineTo(t+r,n+i-o),e.quadraticCurveTo(t+r,n+i,t+r-o,n+i),e.lineTo(t+o,n+i),e.quadraticCurveTo(t,n+i,t,n+i-o),e.lineTo(t,n+o),e.quadraticCurveTo(t,n,t+o,n),e.closePath()}function Ud(e,t){let n=Y(X,this,Ed).call(this,t);e.fillStyle=`#f2fbff`,e.font=`700 29px system-ui`,e.fillText(`MENU`,26,44),e.font=`600 18px system-ui`,e.fillStyle=`#8fdfff`,e.fillText(`Point + trigger or stick. Pad button closes.`,26,74),e.font=`600 20px system-ui`,n.forEach((t,n)=>{let r=104+n*22;n===this.selectedSetting&&(e.fillStyle=`rgba(39, 216, 255, 0.25)`,e.fillRect(20,r-18,472,22)),e.fillStyle=n===this.selectedSetting?`#ffffff`:`#a8cbd8`,e.fillText(`${t.label}`,32,r),e.fillStyle=n===this.selectedSetting?`#7fffd0`:`#d7f7ff`,e.fillText(`${t.value}`,300,r)})}var Z=Object.freeze({BOOT:`BOOT`,SPLASH:`SPLASH`,LOBBY:`LOBBY`,MENU:`MENU`,LEVEL_SELECT:`LEVEL_SELECT`,READY:`READY`,FLYING:`FLYING`,LANDED:`LANDED`,CRASHED:`CRASHED`,DEMO_COMPLETE:`DEMO_COMPLETE`,PAUSED:`PAUSED`,LEVEL_COMPLETE:`LEVEL_COMPLETE`,GAME_COMPLETE:`GAME_COMPLETE`}),Wd={[Z.BOOT]:[Z.SPLASH,Z.LOBBY,Z.MENU,Z.READY],[Z.SPLASH]:[Z.LOBBY,Z.READY],[Z.LOBBY]:[Z.LEVEL_SELECT,Z.READY,Z.MENU],[Z.MENU]:[Z.LEVEL_SELECT,Z.READY,Z.LOBBY],[Z.LEVEL_SELECT]:[Z.MENU,Z.LOBBY,Z.READY],[Z.READY]:[Z.FLYING,Z.PAUSED,Z.MENU,Z.LOBBY],[Z.FLYING]:[Z.PAUSED,Z.LANDED,Z.CRASHED,Z.READY,Z.MENU,Z.DEMO_COMPLETE],[Z.PAUSED]:[Z.FLYING,Z.READY,Z.MENU,Z.LEVEL_SELECT,Z.LOBBY],[Z.LANDED]:[Z.LEVEL_COMPLETE,Z.READY],[Z.LEVEL_COMPLETE]:[Z.READY,Z.GAME_COMPLETE,Z.LEVEL_SELECT,Z.MENU],[Z.CRASHED]:[Z.READY,Z.MENU,Z.LOBBY],[Z.DEMO_COMPLETE]:[Z.READY,Z.MENU,Z.LEVEL_SELECT,Z.LOBBY],[Z.GAME_COMPLETE]:[Z.MENU,Z.LEVEL_SELECT,Z.READY,Z.LOBBY]},Gd=class{constructor(){this.current=Z.BOOT,this.previous=null,this.listeners=new Set,this.timers=new Set}is(e){return this.current===e}canTransition(e){return this.current===e||Wd[this.current]?.includes(e)}transition(e,t={}){return this.canTransition(e)?(this.previous=this.current,this.current=e,this.listeners.forEach(n=>n(e,this.previous,t)),!0):!1}onChange(e){return this.listeners.add(e),()=>this.listeners.delete(e)}delay(e,t){let n=window.setTimeout(()=>{this.timers.delete(n),e()},t);return this.timers.add(n),n}clearTimers(){this.timers.forEach(e=>window.clearTimeout(e)),this.timers.clear()}},Q=new WeakSet,Kd=class{constructor(e,t){cu(this,Q),this.root=e,this.game=t,this.root.insertAdjacentHTML(`beforeend`,Y(Q,this,gf).call(this)),this.hud=e.querySelector(`.hud`),this.overlay=e.querySelector(`.overlay`),this.warning=e.querySelector(`[data-warning]`),this.boostHeld=!1,this.lastTouchActionAt=0,this.hudSide=`left`,this.root.dataset.hudSide=this.hudSide,Y(Q,this,Yd).call(this),Y(Q,this,hf).call(this)}refreshProfile(){this.game.state.is(Z.LOBBY)&&Y(Q,this,Qd).call(this)}update(e){let t=e.nextMarker?Math.max(0,e.nextMarker.distance-e.rocket.distance):0,n=Math.max(0,e.rocket.flightTime-this.game.lastCheckpointTime),r=Math.max(0,Math.min(100,e.rocket.fuel)),i=Math.max(0,Math.min(1,e.altitude/24));this.hud?.style.setProperty(`--fuel`,`${r}%`),this.hud?.style.setProperty(`--altitude-angle`,`${-135+i*270}deg`),Y(Q,this,qd).call(this,`level`,`ENDLESS`),Y(Q,this,qd).call(this,`score`,e.score.progress.totalScore),Y(Q,this,qd).call(this,`best`,e.score.progress.bestTotalScore),Y(Q,this,qd).call(this,`best-distance`,ou(e.score.progress.leaderboard?.bestDistance??0,0)),Y(Q,this,qd).call(this,`best-distance-time`,ou(e.score.progress.leaderboard?.bestDistanceTime??0,1)),Y(Q,this,qd).call(this,`distance`,ou(e.rocket.distance,0)),Y(Q,this,qd).call(this,`marker`,ou(t,0)),Y(Q,this,qd).call(this,`fuel`,ou(e.rocket.fuel,0)),Y(Q,this,qd).call(this,`time`,ou(n,1)),Y(Q,this,qd).call(this,`altitude`,ou(e.altitude)),Y(Q,this,qd).call(this,`altitude-dial`,ou(e.altitude,1)),Y(Q,this,qd).call(this,`vertical`,ou(e.rocket.velocity.y)),Y(Q,this,qd).call(this,`horizontal`,ou(Math.hypot(e.rocket.velocity.x,e.rocket.velocity.z))),Y(Q,this,qd).call(this,`angle`,`${ou(e.rocket.getTiltAngle()*57.3,0)}deg`),Y(Q,this,qd).call(this,`wind`,ou(e.level.windStrength)),Y(Q,this,qd).call(this,`tolerance`,`${ou(e.level.landingThresholds.angle*57.3,0)}deg`),Y(Q,this,qd).call(this,`thrust`,e.rocket.thrusting?`ON`:`OFF`),Y(Q,this,qd).call(this,`camera`,e.camera.mode),Y(Q,this,Jd).call(this,e)}showState(e,t={}){this.root.dataset.state=e,delete this.root.dataset.settingsOpen,e===Z.SPLASH&&Y(Q,this,Zd).call(this),e===Z.LOBBY&&Y(Q,this,Qd).call(this),e===Z.MENU&&Y(Q,this,Xd).call(this),e===Z.LEVEL_SELECT&&Y(Q,this,nf).call(this),e===Z.PAUSED&&Y(Q,this,rf).call(this),e===Z.READY&&(this.overlay.innerHTML=``),e===Z.CRASHED&&Y(Q,this,of).call(this,t.reason??`CRASH`,Y(Q,this,sf).call(this,t.placement)),e===Z.DEMO_COMPLETE&&Y(Q,this,tf).call(this,t.shopUrl,t.reason),e===Z.LANDED&&Y(Q,this,of).call(this,t.grade??`SAVED`,`+${t.points??0} points`),e===Z.LEVEL_COMPLETE&&Y(Q,this,of).call(this,`MARKER SAVED`,`Keep going.`),e===Z.GAME_COMPLETE&&Y(Q,this,of).call(this,`ENDLESS RUN`,`Route continues.`)}showCheckpointReward(e){this.overlay.innerHTML=`<section class="toast checkpoint-toast">
      <strong>MARKER ${e.markerId} SAVED</strong>
      <span>+${e.points} | ${e.elapsed}s | ${e.timeRank}</span>
    </section>`,window.clearTimeout(this.rewardTimer),this.rewardTimer=window.setTimeout(()=>{this.game.state.is(Z.READY)&&(this.overlay.innerHTML=``)},2600)}showMobileTiltPrompt(){this.root.dataset.state=Z.LOBBY,this.overlay.innerHTML=`
      ...
      </section>`}showMobileCalibratePrompt(){this.root.dataset.state=Z.LOBBY,this.overlay.innerHTML=`
      <section class="panel menu-panel mobile-tutorial-panel">
      ...
      </section>`}showMobileReadyPrompt(){this.root.dataset.state=Z.LOBBY,this.overlay.innerHTML=`
      <section class="panel menu-panel mobile-tutorial-panel">
        <h2>Tilt Ready</h2>
        <p>Tilt steering is enabled and calibrated.</p>
        <button data-action="mobile-ok">OK</button>
      </section>`}showMissionHint(){this.overlay.innerHTML=`
      <section class="toast mission-hint">
        <strong>MISSION</strong>
        <span>Thread the gates, collect fuel, land on numbered markers.</span>
      </section>`}};function qd(e,t){let n=this.root.querySelector(`[data-value="${e}"]`);n&&(n.textContent=t)}function Jd({rocket:e,altitude:t,level:n}){let r=Math.hypot(e.velocity.x,e.velocity.z),i=``,a=``;this.root.dataset.emergency=`false`,t<2.2&&!e.landed&&(i=`LOW ALTITUDE`),t<1.8&&!e.landed&&(a=`GROUND`),t<1.15&&e.velocity.y<-.25&&!e.landed&&(a=`PULL UP`),Math.abs(e.velocity.y)>n.landingThresholds.verticalSpeed*.85&&(i=`TOO FAST`),r>n.landingThresholds.horizontalSpeed*.85&&(i=`SIDE SPEED`),e.getTiltAngle()>n.landingThresholds.angle*.85&&(i=`BAD ANGLE`),e.fuel<18&&(i=`LOW FUEL`),e.fuel<=0&&(i=`OUT OF FUEL`),a&&(i=a,this.root.dataset.emergency=`true`),this.warning.textContent=i}function Yd(){this.root.addEventListener(`pointerdown`,e=>{e.target.closest(`[data-boost]`)&&(e.preventDefault(),this.boostHeld=!0,this.game.input.thrust=!0,this.game.audio.unlock())},{passive:!1});let e=e=>{this.boostHeld&&(e.preventDefault(),this.boostHeld=!1,this.game.input.thrust=!1)};this.root.addEventListener(`pointerup`,e,{passive:!1}),this.root.addEventListener(`pointercancel`,e,{passive:!1}),this.root.addEventListener(`pointerleave`,e,{passive:!1}),this.root.addEventListener(`pointerup`,async e=>{if(e.pointerType!==`touch`)return;let t=e.target.closest(`[data-action]`)?.dataset.action;t&&(e.preventDefault(),this.lastTouchActionAt=performance.now(),await Y(Q,this,lf).call(this,t,e.target))},{passive:!1}),this.root.addEventListener(`click`,async e=>{if(performance.now()-this.lastTouchActionAt<450)return;let t=e.target.closest(`[data-action]`)?.dataset.action;t&&await Y(Q,this,lf).call(this,t,e.target)}),this.root.addEventListener(`input`,e=>{let t=e.target;if(!t.dataset.setting)return;let n=t.dataset.setting,r=t.type===`checkbox`?t.checked:Number(t.value);this.game.settings[n]=r,this.game.save.saveSettings(this.game.settings)}),this.root.addEventListener(`change`,e=>{let t=e.target;t.dataset.setting===`cameraMode`?this.game.setCameraMode(t.value):t.dataset.setting===`vrCameraMode`&&(this.game.settings.vrCameraMode=t.value,this.game.save.saveSettings(this.game.settings))})}function Xd(){Y(Q,this,Qd).call(this)}function Zd(){this.overlay.innerHTML=`
      ...
      </section>`}function Qd(){let e=this.game.profile.profile,t=this.game.profile.isLoggedIn(),n=this.game.score.progress.leaderboard??{};this.overlay.innerHTML=`
      <section class="lobby-screen">
        ...
        <div class="lobby-panel lobby-menu">
          <button class="primary" data-action="${t?`play`:`login`}">${t?`Play`:`Log In To Play Demo`}</button>
          <button data-action="store">Store</button>
          ${t?`<button data-action="profile">Profile</button>`:``}
          <button data-action="${t?`level-select`:`login`}">Load Checkpoint</button>
          <button data-action="leaderboard">Leaderboard</button>
        </div>
        <div class="lobby-panel profile-card">
          <h2>Profile</h2>
          <div class="pilot-row">
            <div class="pilot-avatar">${Y(Q,this,ff).call(this,e.name)}</div>
          ...
          ${t?``:`<p class="login-note">Log in with BSG to play the demo.</p><button data-action="login">Log In With BSG</button>`}
          <dl>
            <dt>BSG chips</dt><dd>${ou(e.chips??0,0)}</dd>
            <dt>Best distance</dt><dd>${ou(n.bestDistance??0,0)}m</dd>
            <dt>Best time</dt><dd>${ou(n.bestDistanceTime??0,1)}s</dd>
          </dl>
        </div>
      ...
      </section>`}function $d(){this.overlay.innerHTML=`
      <section class="panel store-panel">
        <h2>Full Version</h2>
        <p>Finish the demo to unlock the full Launch 3001 route from your BSG profile.</p>
        <button data-action="shop" data-shop-url="${Hl}">Go To BSG Shop</button>
        <button data-action="login">Log In With BSG</button>
        <button data-action="lobby">Back To Lobby</button>
      </section>`}function ef(){if(!this.game.profile.isLoggedIn()){Y(Q,this,uf).call(this);return}let e=this.game.profile.profile;this.overlay.innerHTML=`
      <section class="panel profile-panel">
        ...
        <button data-action="store">Store</button>
        <button data-action="lobby">Back To Lobby</button>
      </section>`}function tf(e,t=`landed`){let n=t===`wall`?`Out Of Bounds`:`Nice!`,r=t===`wall`?`You reached the end of the demo zone. Unlock the full Launch 3001 route for $1.99 AUD.`:`You have completed the demo version of Launch 3001. Unlock the full route for $1.99 AUD.`;this.overlay.innerHTML=`
      <section class="panel demo-panel">
        <h2>${n}</h2>
        <p>${r}</p>
        <button data-action="shop" data-shop-url="${e}">Visit Shop</button>
        <button data-action="restart">Replay Demo</button>
        <button data-action="menu">Menu</button>
      </section>`}function nf(){let e=this.game.levels.levels.map(e=>{let t=e.id>this.game.score.progress.highestUnlockedLevel,n=Math.max(1,Math.floor(e.startDistance/180)),r=this.game.score.progress.bestScores[n]??0,i=e.startDistance===0?`START`:this.game.score.progress.bestGrades[n]??`-`;return`<button class="level-card" data-action="level" data-level-id="${e.id}" ${t?`disabled`:``}>
        <strong>${e.name}</strong><span>${t?`LOCKED`:`${ou(e.startDistance,0)}m | ${i} | ${r}`}</span>
      </button>`}).join(``);this.overlay.innerHTML=`<section class="panel level-panel"><h2>Load Checkpoint</h2><div class="level-grid">${e}</div><button data-action="back">Back</button></section>`}function rf(){this.overlay.innerHTML=`<section class="panel control-panel">
      <h2>Menu</h2>
      <div class="control-actions">
        <button data-action="menu">Lobby</button>
        <button data-action="reset-run">Reset</button>
      </div>
    </section>`}function af(){let e=this.game.score.progress.leaderboard??{},t=(e.runs??[]).slice(0,10).map((e,t)=>`
      <div class="leader-row">
        <span>${Y(Q,this,cf).call(this,t+1)} #${t+1}</span>
        <b>${ou(e.distance,0)}m</b>
        <span>${ou(e.time,1)}s</span>
      </div>
    `).join(``);this.overlay.innerHTML=`<section class="panel level-panel">
      <h2>Leaderboard</h2>
      <div class="leader-summary">Best distance <b>${ou(e.bestDistance??0,0)}m</b> in <b>${ou(e.bestDistanceTime??0,1)}s</b></div>
      <div class="leader-list">${t||`<div class="leader-empty">No runs yet</div>`}</div>
      <button data-action="back">Back</button>
    </section>`}function of(e,t){this.overlay.innerHTML=`<section class="toast"><strong>${e}</strong><span>${t}</span></section>`}function sf(e){return e?`${Y(Q,this,cf).call(this,e.placement)} Placed #${e.placement} | ${ou(e.distance,0)}m in ${ou(e.time,1)}s`:`Tap Restart or press R.`}function cf(e){return e===1?`🏆`:e===2?`🥈`:e===3?`🥉`:`•`}async function lf(e,t){if(e===`shop`){this.game.hub.openShop();return}await this.game.audio.unlock(),this.game.audio.playClick(),e===`play`&&(this.game.profile.isLoggedIn()?Y(Q,this,df).call(this):Y(Q,this,uf).call(this)),e===`lobby`&&this.game.showLobby(),e===`store`&&Y(Q,this,$d).call(this),e===`profile`&&Y(Q,this,ef).call(this),e===`login`&&this.game.hub.requestLogin(),e===`level-select`&&(this.game.profile.isLoggedIn()?this.game.state.transition(Z.LEVEL_SELECT):Y(Q,this,uf).call(this)),e===`menu`&&this.game.showLobby(),e===`resume`&&this.game.resume(),e===`close-settings`&&Y(Q,this,pf).call(this),e===`pause`&&this.game.pause(),e===`leaderboard`&&Y(Q,this,af).call(this),e===`hud-side`&&Y(Q,this,mf).call(this),e===`restart`&&this.game.restartLevel(),e===`reset-run`&&this.game.resetRun(),e===`mobile-tilt`&&this.game.enableTiltFromPrompt(),e===`mobile-calibrate`&&this.game.calibrateTiltFromPrompt(),e===`mobile-ok`&&this.game.completeMobileTutorial(),e===`mobile-skip`&&this.game.skipMobileTutorial(),e===`back`&&this.game.showLobby(),e===`level`&&(this.game.profile.isLoggedIn()?this.game.startLevel(Number(t.closest(`[data-level-id]`).dataset.levelId)):Y(Q,this,uf).call(this))}function uf(){this.game.hub.requestLogin(),this.overlay.innerHTML=`
      <section class="panel profile-panel">
        <h2>BSG Login Required</h2>
        <p>You need to be logged in with your BSG profile to play Launch 3001.</p>
        <button data-action="login">Log In With BSG</button>
        <button data-action="lobby">Back To Lobby</button>
      </section>`}function df(){this.overlay.innerHTML=`
      ...
      </section>`,window.setTimeout(()=>this.game.enterGame(),1800)}function ff(e=`Guest Pilot`){return e.split(/\s+/).filter(Boolean).slice(0,2).map(e=>e[0]?.toUpperCase()).join(``)||`GP`}function pf(){if(delete this.root.dataset.settingsOpen,this.game.state.is(Z.PAUSED)){this.game.resume();return}this.uiWasSettings=!1,this.showState(this.game.state.current)}function mf(){this.hudSide=this.hudSide===`left`?`right`:`left`,this.root.dataset.hudSide=this.hudSide,Y(Q,this,hf).call(this)}function hf(){let e=this.root.querySelector(`[data-action="hud-side"]`);e&&(e.textContent=this.hudSide===`left`?`›`:`‹`)}function gf(){return`
      ...
      <div class="hud">
        <div class="build-badge">BUILD ${_d}</div>
      ...
      </div>`}var _f=[`BSG_PROFILE`,`BSG_PROFILE_RESPONSE`,`BSG_AUTH_PROFILE`],vf=new WeakSet,yf=class{constructor(e){cu(this,vf),this.game=e,this.lastHubOrigin=``,this.boundMessage=e=>Y(vf,this,wf).call(this,e)}start(){window.addEventListener(`message`,this.boundMessage),window.launch3001SetProfile=e=>this.applyProfile(e,`global-api`),Y(vf,this,Sf).call(this),Y(vf,this,Cf).call(this),window.requestAnimationFrame(()=>this.requestProfile())}requestProfile(){let e=Y(vf,this,Ef).call(this,`BSG_PROFILE_REQUEST`);Y(vf,this,Tf).call(this,e),Y(vf,this,Tf).call(this,Y(vf,this,Ef).call(this,`BSG_GAME_READY`))}requestLogin(){let e=Y(vf,this,bf).call(this,Vl);Y(vf,this,Tf).call(this,{...Y(vf,this,Ef).call(this,`BSG_LOGIN_REQUEST`),loginUrl:e,returnUrl:window.location.href}),Y(vf,this,xf).call(this,e)}openShop(){let e=new URL(Hl);e.searchParams.set(`product`,Bl),e.searchParams.set(`currency`,`AUD`),e.searchParams.set(`return`,window.location.href),Y(vf,this,Tf).call(this,{...Y(vf,this,Ef).call(this,`BSG_SHOP_REQUEST`),shopUrl:e.toString()}),window.open(e.toString(),`_blank`,`noopener`)}applyProfile(e,t=`hub`){if(!(!e||typeof e!=`object`)){window.__launch3001Profile={...e,source:e.source??t};try{localStorage.setItem(`launch3001.profile`,JSON.stringify(window.__launch3001Profile))}catch{}this.game.refreshProfile()}}};function bf(e){let t=new URL(e);return t.searchParams.set(`product`,Bl),t.searchParams.set(`return`,window.location.href),t.toString()}function xf(e){try{if(window.top&&window.top!==window){window.top.location.href=e;return}}catch{}window.location.href=e}function Sf(){if(!window.location.hash.includes(`bsgToken=`))return;let e=new URLSearchParams(window.location.hash.slice(1));if(e.get(`bsg`)!==`1`)return;let t=e.get(`access`)===`full`,n={id:e.get(`id`)||`bsg-${e.get(`player`)||`player`}`,name:e.get(`player`)||`BSG Player`,email:e.get(`email`)||``,avatar:e.get(`avatar`)||``,token:e.get(`bsgToken`)||``,chips:Math.max(0,Number(e.get(`chips`))||0),purchases:t?{[Bl]:!0}:{},entitlements:t?{[Bl]:!0}:{},source:e.get(`source`)||`bsg-hub`};this.applyProfile(n,`url-handoff`),window.history.replaceState(null,document.title,`${window.location.pathname}${window.location.search}`)}async function Cf(){if(window.location.hostname.endsWith(`.bsg.local`))try{let e=await fetch(Ul,{credentials:`include`});if(!e.ok)return;let t=await e.json(),n=t?.user||t?.profile;if(!n)return;this.applyProfile({id:n.id,name:n.name||n.username||n.sUserName,email:n.email||n.sEmail,avatar:n.avatar||``,chips:n.chips??n.nChips??0,purchases:n.purchases||{},entitlements:n.entitlements||{},source:`bsg-local-platform`},`bsg-local-platform`)}catch{}}function wf(e){_f.includes(e.data?.type)&&Y(vf,this,Of).call(this,e.origin)&&(this.lastHubOrigin=e.origin,this.applyProfile(e.data.profile,e.origin.includes(`bigslickgames.com`)?`bsg-hub`:`local-hub`))}function Tf(e){let t=[window.parent===window?null:window.parent,window.opener].filter(Boolean);for(let n of t)for(let t of Y(vf,this,Df).call(this))n.postMessage(e,t)}function Ef(e){return{type:e,game:Bl,productId:Bl,build:_d,url:window.location.href,requestedFields:[`id`,`name`,`email`,`avatar`,`purchases`,`entitlements`]}}function Df(){let e=new Set(Wl);return this.lastHubOrigin&&e.add(this.lastHubOrigin),window.location.origin.startsWith(`http`)&&e.add(window.location.origin),[...e]}function Of(e){return!e||e===`null`?!1:e===window.location.origin||Wl.includes(e)}var $=new WeakSet,kf=class{constructor(e){cu(this,$),this.root=e,this.root.className=`game-root`,this.scene=new En,this.camera=new Ka(58,1,.1,140),this.renderer=new Rl(e),this.save=new ed,this.settings=this.save.loadSettings(),this.profile=new rd(this.save),this.fullAccess=this.profile.hasPurchase(),this.score=new ld(this.save),this.audio=new fd(this.settings),this.levels=new Ku,this.world=new Lu(this.scene),this.rocket=new uu,this.scene.add(this.rocket.group),this.padShadow=Y($,this,Xf).call(this),this.scene.add(this.padShadow),this.input=new pu(this.renderer.renderer.domElement,this.settings),this.physics=new vu,this.cameraController=new bu(this.camera,this.settings),this.vr=new vd(this.renderer,this.scene,this.camera),this.hub=new yf(this),this.effects=new gd(this.scene),this.collision=new Bu(this.world),this.state=new Gd,this.ui=new Kd(e,this),this.lastTime=0,this.accumulator=0,this.running=!1,this.currentLevel=this.levels.current,this.currentStartId=1,this.activeLanding=!1,this.runRecorded=!1,this.takeoffLocked=!1,this.lastCheckpointTime=0,this.landedPad=null,this.passedMarkers=new Set,this.collectedDrops=new Set,this.refillRemaining=new Map,this.voiceFlags={},this.mobileTutorialDone=!1,this.missionHintDone=localStorage.getItem(`launch3001.missionHintDone`)===`1`,this.state.onChange((e,t,n)=>this.ui.showState(e,n)),Y($,this,ep).call(this)}refreshProfile(){this.profile.refresh(),this.fullAccess=this.profile.hasPurchase(),this.ui.refreshProfile()}start(){this.loadLevel(1),this.hub.start(),this.state.transition(Z.SPLASH),this.renderer.resize(this.camera),this.running=!0,this.renderer.setAnimationLoop((e,t)=>Y($,this,Af).call(this,e,t))}loadLevel(e){this.state.clearTimers(),this.profile.refresh(),this.fullAccess=this.profile.hasPurchase(),this.activeLanding=!1,this.runRecorded=!1,this.currentStartId=e,this.currentLevel=this.levels.load(e),this.world.load(this.currentLevel);let t=this.currentLevel.launchPad.position;this.rocket.reset({x:t.x,y:t.y+.12+Ql,z:t.z}),this.rocket.landed=!0,this.takeoffLocked=!0,this.lastCheckpointTime=0,this.landedPad=this.currentLevel.launchPad,this.passedMarkers=new Set,this.collectedDrops=new Set,this.refillRemaining=new Map,this.voiceFlags={launch:!1,lowFuel:!1,approachMarkerId:null,refuelPad:null},this.cameraController.update(this.rocket,1),this.renderer.resize(this.camera)}startLevel(e){if(!this.profile.isLoggedIn()){this.hub.requestLogin(),this.showLobby();return}let t=Math.min(e,this.levels.levels.length);t>this.score.progress.highestUnlockedLevel||(this.loadLevel(t),this.score.recordAttempt(t),this.state.transition(Z.READY))}restartLevel(){this.audio.stopEngine(),this.loadLevel(this.currentStartId),this.score.recordAttempt(this.currentStartId),this.state.transition(Z.READY)}resetRun(){this.score.resetRun(),this.startLevel(1)}showLobby(){this.audio.stopEngine(),this.state.clearTimers(),this.state.transition(Z.LOBBY),Y($,this,tp).call(this)&&!this.mobileTutorialDone&&this.ui.showMobileTiltPrompt()}enterGame(){if(!this.profile.isLoggedIn()){this.hub.requestLogin(),this.showLobby();return}if(Y($,this,tp).call(this)&&!this.mobileTutorialDone){this.ui.showMobileTiltPrompt();return}this.startLevel(this.score.progress.highestUnlockedLevel),this.missionHintDone||this.ui.showMissionHint()}pause(){(this.state.is(Z.FLYING)||this.state.is(Z.READY))&&(this.audio.stopEngine(),this.state.transition(Z.PAUSED))}resume(){if(!this.state.is(Z.PAUSED)){this.ui.showState(this.state.current);return}this.state.transition(this.rocket.flightTime>0?Z.FLYING:Z.READY)}goMenu(){this.audio.stopEngine(),this.state.clearTimers(),this.state.transition(Z.MENU)}toggleCamera(){let e=this.cameraController.toggle();this.settings.cameraMode=e,this.save.saveSettings(this.settings)}setCameraMode(e){this.cameraController.setMode(e),this.settings.cameraMode=this.cameraController.mode,this.save.saveSettings(this.settings)}flipSideCamera(){this.settings.sideCameraSide=(this.settings.sideCameraSide??1)*-1,this.save.saveSettings(this.settings)}async enableTilt(){let e=await this.input.enableTilt();return e&&this.input.calibrate(),e}async enableTiltFromPrompt(){let e=await this.enableTilt();return e?this.ui.showMobileCalibratePrompt():this.ui.showMobileTiltPrompt(),e}async enableAudio(){await this.audio.enable(),this.save.saveSettings(this.settings)}calibrateTiltFromPrompt(){this.input.calibrate(),this.ui.showMobileReadyPrompt()}completeMobileTutorial(){this.mobileTutorialDone=!0,this.state.transition(Z.LOBBY),this.ui.showState(Z.LOBBY)}skipMobileTutorial(){this.mobileTutorialDone=!1,this.state.transition(Z.LOBBY),this.ui.showState(Z.LOBBY)}};function Af(e){if(!this.running)return;let t=Math.min((e-this.lastTime)/1e3||0,eu);if(this.lastTime=e,!document.hidden&&!this.state.is(Z.PAUSED)&&!this.state.is(Z.MENU)&&!this.state.is(Z.LEVEL_SELECT)&&!this.state.is(Z.DEMO_COMPLETE)&&!this.state.is(Z.SPLASH)&&!this.state.is(Z.LOBBY))for(this.accumulator+=t;this.accumulator>=$l;)Y($,this,jf).call(this,$l),this.accumulator-=$l;Y($,this,Mf).call(this,t),this.renderer.render(this.scene,this.camera)}function jf(e){this.input.update();let t=Y($,this,Ff).call(this),n=Y($,this,Pf).call(this);if(n||(this.takeoffLocked=!1),this.vr.enabled&&this.state.is(Z.CRASHED)&&n){this.restartLevel();return}this.state.is(Z.READY)&&n&&!this.takeoffLocked&&(Y($,this,Hf).call(this),this.state.transition(Z.FLYING),this.voiceFlags.launch||(this.audio.speak(`We are clear for launch!`,`launch`,8e3),this.voiceFlags.launch=!0));let r=this.state.is(Z.FLYING);if(this.rocket.setFlame(r&&n&&this.rocket.fuel>0),this.rocket.thrusting?this.audio.startEngine():this.audio.stopEngine(),this.physics.step(this.rocket,this.currentLevel,t,e,r,this.settings),this.world.updateMovingHazards(this.rocket.flightTime),Y($,this,Nf).call(this,e,r),this.rocket.updateVisual(e,t,this.settings),Y($,this,qf).call(this,e),this.score.updateLeaderboard(this.rocket.distance,this.rocket.flightTime),r){Y($,this,Uf).call(this,e);let t=this.collision.check(this.rocket,this.currentLevel);t?.type===`crash`&&Y($,this,If).call(this,t.reason),t?.type===`landed`&&Y($,this,Rf).call(this,t.grade,t.marker),Y($,this,Bf).call(this)}}function Mf(e){this.vr.consumeSessionStart()&&(this.state.is(Z.MENU)||this.state.is(Z.LEVEL_SELECT)?this.startLevel(this.score.progress.highestUnlockedLevel):this.state.is(Z.PAUSED)&&this.resume()),this.input.consumeAction(`r`)&&this.restartLevel(),this.input.consumeAction(`c`)&&this.toggleCamera(),this.input.consumeAction(`escape`)&&(this.state.is(Z.PAUSED)?this.resume():this.pause()),this.vr.enabled?this.vr.update(this,e):this.cameraController.update(this.rocket,e),this.effects.update(e,this.rocket);let t=this.rocket.position.y-this.world.getTerrainHeight(this.rocket.position.x,this.rocket.position.z)-this.rocket.radius;Y($,this,Zf).call(this),Y($,this,$f).call(this,t),this.ui.update({level:this.currentLevel,rocket:this.rocket,altitude:t,score:this.score,camera:this.cameraController,nextMarker:Y($,this,Qf).call(this)})}function Nf(e,t){t||this.rocket.flightTime<=0||!this.state.is(Z.READY)&&!this.state.is(Z.LANDED)||(this.rocket.flightTime+=e)}function Pf(){return(this.input.thrust||this.vr.getInput().thrust)&&this.rocket.fuel>0}function Ff(){if(this.rocket.landed||this.state.is(Z.READY)||this.state.is(Z.LANDED))return{x:0,z:0};let e=this.input.getSteering(),t=this.vr.getInput().steering;return{x:Math.max(-1,Math.min(1,e.x+t.x)),z:Math.max(-1,Math.min(1,e.z+t.z))}}function If(e){if(!this.state.is(Z.FLYING))return;this.rocket.alive=!1,this.rocket.setFlame(!1),this.audio.stopEngine(),this.audio.playCrash(),this.effects.burst(this.rocket.position,16726815,24),this.cameraController.addShake(.45),navigator.vibrate&&navigator.vibrate(80);let t=Y($,this,Lf).call(this);this.state.transition(Z.CRASHED,{reason:e,placement:t})}function Lf(){return this.runRecorded||this.rocket.distance<=0?null:(this.runRecorded=!0,this.score.recordRun(this.rocket.distance,this.rocket.flightTime))}function Rf(e,t=this.currentLevel.landingPad){if(!this.state.is(Z.FLYING)||this.activeLanding||this.passedMarkers.has(t.id))return;this.activeLanding=!0,this.rocket.landed=!0,this.rocket.alive=!1,this.rocket.setFlame(!1),this.audio.stopEngine();let n=t.position;this.landedPad=t,this.rocket.position.set(n.x,n.y+.12+Ql,n.z),this.rocket.velocity.set(0,0,0);let r=Math.max(.1,this.rocket.flightTime-this.lastCheckpointTime),i=this.score.scoreCheckpoint(t,r,t.distance??this.rocket.distance),a=this.score.checkpointBreakdown(t,r,t.distance??this.rocket.distance),o=Math.min(this.levels.levels.length,Math.floor((t.distance??0)/540)+1);if(this.score.commitCheckpoint(t,i,o),this.passedMarkers.add(t.id),this.lastCheckpointTime=this.rocket.flightTime,this.audio.playLanding(e===Jl.perfect),this.audio.playCheckpoint(),this.effects.emitLandingDust(this.rocket.position),this.effects.burst(this.rocket.position,e===Jl.perfect?3407754:2406399,14),this.takeoffLocked=!0,this.rocket.alive=!0,this.activeLanding=!1,Y($,this,Jf).call(this,t,$l),Y($,this,zf).call(this,t)){Y($,this,Vf).call(this,t);return}this.state.transition(Z.READY),this.ui.showCheckpointReward(a),this.audio.speak(`Touchdown.`,`touchdown`,2500)}function zf(e){return!this.fullAccess&&e.id>=2}function Bf(){if(this.fullAccess||!this.state.is(Z.FLYING))return;let e=(this.currentLevel.checkpoints??[]).find(e=>e.id===2);!e||this.rocket.distance<e.distance+24||(this.rocket.alive=!1,this.rocket.landed=!1,this.rocket.setFlame(!1),this.rocket.velocity.set(0,0,0),this.audio.stopEngine(),Y($,this,Vf).call(this,e,`wall`))}function Vf(e,t=`landed`){this.state.transition(Z.DEMO_COMPLETE,{marker:e,shopUrl:Hl,reason:t}),this.audio.speak(`Nice! You have completed the demo version of Launch 3001.`,`demoComplete`,12e3)}function Hf(){this.rocket.alive=!0,this.rocket.landed=!1,this.landedPad=null,this.activeLanding=!1,this.missionHintDone||(this.missionHintDone=!0,localStorage.setItem(`launch3001.missionHintDone`,`1`))}function Uf(e){for(let t of this.currentLevel.pickups??[]){if(!Y($,this,Kf).call(this,t))continue;if(t.type===`refill`){Y($,this,Wf).call(this,t,e);continue}if(this.collectedDrops.has(t.id))continue;this.collectedDrops.add(t.id),this.rocket.fuel=Math.min(100,this.rocket.fuel+t.amount);let n=this.world.current.pickupMeshes?.find(e=>e.name===`Drop ${t.id}`);n&&(n.visible=!1),this.effects.burst(this.rocket.position,5105407,12),this.audio.speak(`Refueled Sir!`,`fuelPickup`,1200)}}function Wf(e,t){if(this.collectedDrops.has(e.id)||this.rocket.fuel>=100)return;let n=this.refillRemaining.get(e.id)??e.amount;if(n<=0){Y($,this,Gf).call(this,e);return}let r=Math.min(n,100-this.rocket.fuel,(e.refillRate??26)*t);r<=0||(this.refillRemaining.set(e.id,n-r),this.rocket.fuel=Math.min(100,this.rocket.fuel+r),this.effects.burst(this.rocket.position,16765286,2),this.voiceFlags.activeRefill!==e.id&&(this.audio.speak(`Refueling Sir!`,`holdRefuel`,1800),this.voiceFlags.activeRefill=e.id),n-r<=.05&&Y($,this,Gf).call(this,e))}function Gf(e){this.collectedDrops.add(e.id);let t=this.world.current.pickupMeshes?.find(t=>t.name===`Drop ${e.id}`);t&&(t.visible=!1),this.effects.burst(this.rocket.position,16765286,12)}function Kf(e){let t=this.rocket.position.x-e.position.x,n=this.rocket.position.z-e.position.z,r=Math.hypot(t,n),i=Math.abs(this.rocket.position.y-e.position.y);return r<=e.radius+this.rocket.radius+1.05&&i<=2.2}function qf(e){if(!this.state.is(Z.READY)&&!this.state.is(Z.LANDED))return;let t=this.rocket.landed&&this.landedPad?this.landedPad:Y($,this,Yf).call(this);t&&Y($,this,Jf).call(this,t,e)}function Jf(e,t){this.rocket.fuel<99&&this.voiceFlags.refuelPad!==e.id&&(this.audio.speak(`We will take some fuel Captain!`,`padRefuel`,5e3),this.voiceFlags.refuelPad=e.id),this.rocket.fuel=Math.min(100,this.rocket.fuel+20*t)}function Yf(){return[this.currentLevel.launchPad,...this.currentLevel.checkpoints??[]].find(e=>Math.abs(this.rocket.position.x-e.position.x)<=e.size.x/2&&Math.abs(this.rocket.position.z-e.position.z)<=e.size.z/2&&Math.abs(this.rocket.position.y-1.58-(e.position.y+.12))<1.2)}function Xf(){let e=new K(new Wi(.9,32),new Yr({color:0,transparent:!0,opacity:0,depthWrite:!1}));return e.name=`Rocket pad shadow`,e.rotation.x=-Math.PI/2,e.visible=!1,e}function Zf(){let e=(this.currentLevel.checkpoints??[]).find(e=>Math.abs(this.rocket.position.x-e.position.x)<=e.size.x/2&&Math.abs(this.rocket.position.z-e.position.z)<=e.size.z/2);if(!e){this.padShadow.visible=!1;return}let t=e.position.y+.14,n=Math.max(.1,this.rocket.position.y-t-Ql),r=Math.max(0,Math.min(.42,.42-n*.055));this.padShadow.visible=r>.03,this.padShadow.material.opacity=r,this.padShadow.position.set(this.rocket.position.x,t+.025,this.rocket.position.z);let i=Math.max(.65,Math.min(2.2,.75+n*.16));this.padShadow.scale.set(i,i,1)}function Qf(){return(this.currentLevel.checkpoints??[]).find(e=>!this.passedMarkers.has(e.id))}function $f(e){if(!this.state.is(Z.FLYING))return;e<1.35&&this.rocket.velocity.y<-.28&&this.audio.speak(`Emergency, pull up!`,`emergencyAltitude`,2600),e<2.4&&this.rocket.velocity.y<-.45&&this.audio.speak(`Watch your altitude captain!`,`altitude`,5e3),this.rocket.fuel<=50&&!this.voiceFlags.lowFuel?(this.audio.speak(`Watch your fuel Cap!`,`lowFuel`,12e3),this.voiceFlags.lowFuel=!0):this.rocket.fuel>65&&(this.voiceFlags.lowFuel=!1);let t=Y($,this,Qf).call(this);t&&Math.hypot(this.rocket.position.x-t.position.x,this.rocket.position.z-t.position.z)<34&&this.voiceFlags.approachMarkerId!==t.id&&(this.audio.speak(`Cleared for landing.`,`landingClear`,4500),this.voiceFlags.approachMarkerId=t.id)}function ep(){let e=()=>this.renderer.resize(this.camera),t=()=>this.audio.unlock(),n=e=>{let t=e.target?.tagName?.toLowerCase();t===`input`||t===`select`||t===`textarea`||e.preventDefault()};window.addEventListener(`pointerdown`,t,{passive:!0}),window.addEventListener(`keydown`,t),document.addEventListener(`selectstart`,e=>e.preventDefault()),document.addEventListener(`selectionchange`,()=>window.getSelection()?.removeAllRanges()),document.addEventListener(`contextmenu`,e=>e.preventDefault()),document.addEventListener(`touchstart`,n,{passive:!1}),document.addEventListener(`touchmove`,n,{passive:!1}),window.addEventListener(`resize`,e),screen.orientation?.addEventListener?.(`change`,e),window.addEventListener(`orientationchange`,()=>window.setTimeout(e,80)),document.addEventListener(`visibilitychange`,()=>{document.hidden&&this.state.is(Z.FLYING)&&this.pause()})}function tp(){return navigator.maxTouchPoints>1||/android|iphone|ipad|ipod|mobile/i.test(navigator.userAgent)}var np=new kf(document.querySelector(`#app`));np.start(),window.launch3001=np;